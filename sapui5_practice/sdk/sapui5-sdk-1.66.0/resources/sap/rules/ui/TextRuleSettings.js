    ...
    function (jQuery, library, Control, SimpleForm, Label, Switch, Select, MessageBox, Table, Column, Text, Input, Button, ComboBox,
        ...
        sap.rules.ui.TextRuleSettings.prototype._getASTExpressionBasic = function (oContext, expressionID, expression, businessDataType,
            ...
            var oASTExpressionBasic = new ASTExpressionBasic({
                ...
                change: function (oEvent) {
                    ...
                    that._updateResultAttributeJSON(oContext, null, sValue, null, astNodes);
        ...
        sap.rules.ui.TextRuleSettings.prototype._getPredefinedExpressionAdvanced = function (oContext, expressionID, expression,
            ...
            return new ExpressionAdvanced({
                ...
                change: function (oEvent) {
                    ...
                    this._updateResultAttributeJSON(oContext, null, oSource.getValue(), astString, []);
                }.bind(this)
            }).setBindingContext(oContext);
        };
        ...
        sap.rules.ui.TextRuleSettings.prototype._predefinedFactory = function (sId, oContext) {
            ...
            if (this._internalModel.getProperty("/resultDataObjectChanged")) {
                ...
                this._updateResultAttributeJSON(oContext, sSelectedKey, expression, ast, astNodes);
            } else {
        ...
        sap.rules.ui.TextRuleSettings.prototype._setColumnAccessMode = function (oContext, oEvent) {
            ...
            if (expressionControl instanceof ExpressionAdvanced) {
                if (sSelectedMode === Constants.KEY_HIDDEN) {
                    ...
                    this._updateResultAttributeJSON(oContext, Constants.HIDDEN, null, null, null);
                } else {
                    expressionControl.setValueStateText("");
                    this._updateResultAttributeJSON(oContext, Constants.EDITABLE, null, null, null);
                }
            } else {
                if (sSelectedMode === Constants.KEY_HIDDEN) {
                    expressionControl.setValue("");
                    ...
                    for (attribute in newResultJsonObjects) {
                        if (newResultJsonObjects[attribute].updatePredefinedResults) {
						    ...
						    if (newResultJsonObjects[attribute].ASTNodes) {
								var updateResultPath = "/TextRuleResults(RuleId='" + sRuleId + "',RuleVersion='" + sRuleVersion + "',Id='" +
									newResultJsonObjects[
										attribute].Id + "')";
								var resultBody = {
								...
								_removeExistingAstNodes(newResultJsonObjects[attribute].Id);
								_updateModelAstNodes(newResultJsonObjects[attribute].ASTNodes, newResultJsonObjects[attribute].Id);
							}

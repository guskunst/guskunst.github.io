...
sap.ui.define([
    ...
    Link, Label, BusyIndicator, DisplayListItem, MenuItem, FlexBox, MessageStrip, DecisionTableSettingsOld, DecisionTableCellFormatter, ConstantUtils, AstExpressionLanguage) {
	...
	_closePopover: function () {
            ...
            if (columnType === sap.rules.ui.DecisionTableColumn.Condition) {
                ...
                oText.bindText({
                    ...
                    formatter: function (sExpression, sFixedOperator) {
                        //bug RULES-5278
                        var titleText = displayExpression ? displayExpression : sExpression;
                        if (sFixedOperator) {
                            titleText += " " + sFixedOperator;
                        }
                        return titleText;
                    }
                });
        ...
        _getExpressionFromAstNodes: function (oContext) {
            ...
            if (astList && astList.length > 0) {
                ...
                columnArray[oContext.getPath()] = {
                    "headerValue": displayExpression.relString + " " + fixedOperator
                };                
        ...
        _updateTableCell: function (oCell, oRowContext, dtDomElement, rowIndex) {
            ...
            if (oRowContext) {
                ...
                var cellBindingPath = "DecisionTableRowCells(RuleId='" + ruleId + "',Version='" + version + "',RowId=" + rowId + ",ColId=" + colId +
                    ")";
                var oCellContext = new sap.ui.model.Context(oRowContext.getModel(), cellBindingPath);
                var sConditionPath = "/DecisionTableColumnConditions(RuleId='" + ruleId + "',Version='" + version + "',Id=" + colId + ")";
                var sConditionPathAlternate = "/DecisionTableColumnConditions(RuleId='" + ruleId + "',Id='" + colId + "',Version=" + version + ")";
                ...
                case "CONDITION":
                    ...
                    } else if (columnArray[sConditionPathAlternate]) {
                    	oCell.setHeaderInfo(columnArray[sConditionPathAlternate]);
                    }
                    break;
                case "RESULT":
                    ...
                    if (sap.ui.getCore().byId(oParent.getAstExpressionLanguage())) {
                        ...
                        var sAttributeId = oRowContext.oModel.getProperty(headerPath + '/DataObjectAttributeId');
                ...
                var rowCellKeyProperties = {
                    RuleId: ruleId,
                    Version: version,
                    RowId: rowId,
                    ColId: colId
                };
                oCell.setKeyProperties(rowCellKeyProperties);
        ...
        setAstExpressionLanguage: function (value) {
            ...
            this._decisionTableCellFormatter.setExpressionLanguage(this.getAstExpressionLanguage());

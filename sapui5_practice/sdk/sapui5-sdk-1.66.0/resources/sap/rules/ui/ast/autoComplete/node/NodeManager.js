        ...
        NodeManager.prototype.getNode = function (token, prefixId) {
            switch (token.getTokenType()) {
                case Constants.TERM:
                    ...
                    if (oTerm) {
                        oTermNode.setName(oTerm.getTermName()).setLabel(oTerm.getLabel()).
                            setId(oTerm.getTermId()).setBusinessDataType(oTerm.getBusinessDataType())
                            .setDataObjectType(oTerm.getDataObjectType());
                    } else {

...
sap.ui.define(["sap/ui/thirdparty/jquery",
		...
		var TextRule = RuleBase.extend("sap.rules.ui.TextRule", {
					...
					return new AstExpressionBasic({
						...
						change: function (oEvent) {
                					...
                					var oModel = new sap.ui.model.odata.v2.ODataModel({
                    							serviceUrl: oContext.getModel().sServiceUrl
                					});
                					that._updateModelExpression(sPath, oContext, oContext.getProperty("Expression"));
			...
			_getExpressionFromAstNodes: function (oContext) {
				...
				var astList = [];
				var astNodes = [];
				if (oContext.sPath.includes("TextRuleConditions")) {
			...
			_updateModelAstNodes: function (sPath, oContext, astNodes, oModel) {
				...
				var createPath = "";
				var oRuleData = {};
				if (sPath.includes("TextRuleConditions")) {
			...
			_removeExistingAstNodes: function (sPath, oContext, astNodes, expressionConverted, oModel) {
				...
				if (sPath.includes("TextRuleResult")) {
					deletePath = "/DeleteTextRuleResultASTDraft";
				}
				if (sPath.includes("TextRuleResultExpression")) {

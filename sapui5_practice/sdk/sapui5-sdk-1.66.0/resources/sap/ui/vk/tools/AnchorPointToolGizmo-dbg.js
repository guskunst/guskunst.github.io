...
sap.ui.define([
	...
	AnchorPointToolGizmo.prototype.init = function() {
		...
		this._coordinateSystem = sap.ui.vk.tools.CoordinateSystem.World;
	...
	AnchorPointToolGizmo.prototype.getCoordinateSystem = function() {
		return this._coordinateSystem;
	};

	AnchorPointToolGizmo.prototype.setCoordinateSystem = function(coordinateSystem) {
	...
	AnchorPointToolGizmo.prototype._setRotationAxisAngle = function(axisIndex, angle1, angle2) {
		...
		if (this._tool.fireEvent("rotating", { x: THREE.Math.radToDeg(euler.x), y: THREE.Math.radToDeg(euler.y), z: THREE.Math.radToDeg(euler.z) }, true)) {
			...
			deltaAngle *= this._coordinateSystem === library.CoordinateSystem.Local ? -1 : 1;
			for (var i = 0; i <= n; i++) {
	...
	AnchorPointToolGizmo.prototype.onBeforeRendering = function() {
		jQuery.sap.assert(false, "AnchorPointToolGizmo.onBeforeRendering");
	};

	AnchorPointToolGizmo.prototype.onAfterRendering = function() {
		jQuery.sap.assert(false, "AnchorPointToolGizmo.onAfterRendering");
	};

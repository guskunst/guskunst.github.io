...
sap.ui.define([
	...
	RotateToolGizmo.prototype.init = function() {
		...
		for (var i = 0; i < 3; i++) {
			var color = 0;
			switch (i) {
				case 0: color = library.AxisColours.x; break;
				case 1: color = library.AxisColours.y; break;
				case 2: color = library.AxisColours.z; break;
				default: break;
			}
	...
	RotateToolGizmo.prototype._getAnchorPoint = function() {

...
sap.ui.define([
	...
	*/
	...
	NodeHierarchy.prototype.createNode = function(parentNode, name, insertBeforeNode) {
		...
		jQuery.sap.assert(parentNode.children[parentNode.children.length - 1] === object3D, sap.ui.vk.getResourceBundle().getText("NODEHIERARCHY_MSG_CREATENODEFAILED"));
		if (insertIndex >= 0) {
	...
	NodeHierarchy.prototype.createNodeCopy = function(nodeToCopy, parentNode, name, insertBeforeNode) {
		...
		jQuery.sap.assert(parentNode.children[parentNode.children.length - 1] === clone, sap.ui.vk.getResourceBundle().getText("NODEHIERARCHY_MSG_CREATENODEFAILED"));
		if (insertIndex >= 0) {
			parentNode.children.splice(insertIndex, 0, parentNode.children.pop());
		}

...
sap.ui.define([
	"jquery.sap.global", "../library", "./thirdparty/three", "sap/ui/base/ManagedObject", "./Billboard", "../ve/thirdparty/html2canvas",
	"./PolylineGeometry", "./PolylineMaterial", "./PolylineMesh"
], function(jQuery, library, threeJs, BaseObject, Billboard, html2canvas,
	PolylineGeometry, PolylineMaterial, PolylineMesh) {
	"use strict";
	...
	var Callout = Billboard.extend("sap.ui.vk.threejs.Callout", /** @lends sap.ui.vk.threejs.Callout.prototype */ {
		...
		constructor: function(sId, mSettings, oScope) {
			Billboard.apply(this, arguments);

			this._billboard.material.depthTest = this.getDepthTest();
	...
	Callout.prototype._update = function(renderer, camera, rendererSize) {
		...
		var circularShape = this.getStyle() === sap.ui.vk.BillboardStyle.CircularShape;
		...
		this._lines.forEach(function(line) {
			...
			line.computeLineDistances(matWorldViewProj, viewportSize, nearZ);
	...
	Callout.prototype._createMarkMesh = function(color, lineStyle, headStyle, styleConstant) {
		var arrowHead = headStyle === sap.ui.vk.LeaderLineMarkStyle.Arrow;
	...
	Callout.prototype.addLeaderLine = function(vertices, targetNode, material, startPointStyle, endPointStyle, styleConstant, extensionLength) {
		...
		this._node.add(polylineMesh);
		this._lines.push(polylineMesh);

		if (startPointStyle !== sap.ui.vk.LeaderLineMarkStyle.None) {

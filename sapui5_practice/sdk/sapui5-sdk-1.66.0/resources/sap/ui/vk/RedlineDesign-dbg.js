...
sap.ui.define([
	"jquery.sap.global", "./library", "sap/ui/core/Control", "./RedlineSurface", "./RedlineElement", "./RedlineGesturesHandler", "./RedlineDesignHandler", "./Loco", "./RedlineDesignRenderer"
], function(jQuery, library, Control, RedlineSurface, RedlineElement, RedlineGesturesHandler, RedlineDesignHandler, Loco, RedlineDesignRenderer) {
		"use strict";

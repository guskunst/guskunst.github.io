...
sap.ui.define([
	"./Commands",
	"./CameraHandler", "./TreeHandler", "./NotificationHandler", "./MeshHandler", "./MaterialHandler", "./ImageHandler", "./ViewHandler", "./AnimationHandler", "./AnnotationHandler"
], function(Commands, CameraHandler, TreeHandler, NotificationHandler, MeshHandler, MaterialHandler, ImageHandler, ViewHandler, AnimationHandler, AnnotationHandler) {
	"use strict";
	...
	var Processor = function() {
		...
		this.process = function(state, command) {
			...
			switch (command.name) {
				...
				case Commands.setHighlightStyle:

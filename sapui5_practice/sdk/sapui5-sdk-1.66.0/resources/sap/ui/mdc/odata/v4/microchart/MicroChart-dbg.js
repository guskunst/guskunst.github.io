...
sap.ui.define([
	...
	var ValueColor = mobilelibrary.ValueColor;
		...
		MicroChart._helper = {
			...
			/**
			 * Returns path to entity set of current context in XML binding format
			 *
			 * @param {object} oEntitySet entity set object
			 * @param {object} oValues value object
			 * @return {string} Current entity set path as expression binding
			 */
			getEntitySetPathBinding: function(oEntitySet, oValues) {
				return "{/" + oValues.context.getPath().split("/")[1] + "}";
			},

			/**
			 * Replace MeasureAttributes with Dimensions
			 *
			 * // TODO can this be done in the xml template?
			 *
			 @ private
			 */
			getDimension: function(oMeasureType, oValues) {
				return "{" + oValues.context.getModel().getProperty(oValues.context.getPath().replace("MeasureAttributes","Dimensions") + "/$PropertyPath") + "}";
			},

...
sap.ui.define([
	...
	function(
		...
		Condition.checkIsEmpty = function(aConditions, oFilterOpConfig) {
			if (!Array.isArray(aConditions)) {
				aConditions = [aConditions];
			}

			if (!oFilterOpConfig) {
				throw new Error("checkIsEmpty needs FilterOperatorConfig");
			}
		...
		Condition.updateValues = function(aConditions, oFilterOpConfig) {
			if (!Array.isArray(aConditions)) {
				aConditions = [aConditions];
			}

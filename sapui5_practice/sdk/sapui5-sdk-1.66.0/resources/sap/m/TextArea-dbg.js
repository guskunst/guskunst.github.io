...
function(
	...
	/**
	 * Handles the <code>sapend</code> pseudo event when the Up arrow key is pressed.
	 *
	 * @param {jQuery.Event} oEvent The event object.
	 */
	TextArea.prototype.onsapend = function (oEvent) {
		this.handleScrollByKeyboard(oEvent, true);
	};

	/**
	 * Handles the <code>saphome</code> pseudo event when the Up arrow key is pressed.
	 *
	 * @param {jQuery.Event} oEvent The event object.
	 */
	TextArea.prototype.onsaphome = function (oEvent) {
		this.handleScrollByKeyboard(oEvent, false);
	};

	/**
	 * Handles the <code>sappagedown</code> pseudo event when the Up arrow key is pressed.
	 *
	 * @param {jQuery.Event} oEvent The event object.
	 */
	TextArea.prototype.onsappagedown = function(oEvent) {
		this.handleScrollByKeyboard(oEvent, true);
	};

	/**
	 * Handles the <code>sappageup</code> pseudo event when the Up arrow key is pressed.
	 *
	 * @param {jQuery.Event} oEvent The event object.
	 */
	TextArea.prototype.onsappageup = function(oEvent) {
		this.handleScrollByKeyboard(oEvent, false);
	};

	/**
	 * Handles the <code>sapdown</code> pseudo event when the Up arrow key is pressed.
	 *
	 * @param {jQuery.Event} oEvent The event object.
	 */
	TextArea.prototype.onsapdown = function (oEvent) {
		this.handleScrollByKeyboard(oEvent, true);
	};
	 ...
	 * @param {jQuery.Event} oEvent The event object.
	 */
	TextArea.prototype.onsapup = function (oEvent) {
		this.handleScrollByKeyboard(oEvent, false);
	};

	/**
	 * Handles events, triggering scrolling of the content.
	 *
	 * @param {jQuery.Event} oEvent The event object.
	 * @param {boolean} bScrollDown If true, the event triggers scrolling
	 * down of the content.
	 *
	 * @private
	 */
	TextArea.prototype.handleScrollByKeyboard = function (oEvent, bScrollDown) {
		var oFocusDomRef, iScrollTop, iHeight,
			iScrollHeight, bShouldNotScrollDown, bShouldNotScrollUp;
		...
		iScrollTop = oFocusDomRef.scrollTop;
		iHeight = oFocusDomRef.clientHeight;
		iScrollHeight = oFocusDomRef.scrollHeight;
		bShouldNotScrollDown = bScrollDown && Math.ceil(iScrollTop + iHeight) === iScrollHeight;
		bShouldNotScrollUp = !bScrollDown && !oFocusDomRef.scrollTop;

		if (bShouldNotScrollDown || bShouldNotScrollUp) {

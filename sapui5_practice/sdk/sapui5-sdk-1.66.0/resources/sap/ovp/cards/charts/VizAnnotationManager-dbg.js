...
sap.ui.define(["jquery.sap.global", "sap/ovp/cards/charts/Utils", "sap/ui/model/odata/CountMode",
        ...
        "sap/viz/ui5/data/MeasureDefinition", "sap/viz/ui5/controls/common/feeds/FeedItem", "sap/ui/core/Element", "sap/ovp/app/resources", "sap/ovp/app/OVPUtils"],
    function (jQuery, Utils, CountMode, CardAnnotationHelper, NumberFormat, DateFormat,
              ...
              MeasureDefinition, FeedItem, CoreElement, OvpResources, OVPUtils) {
        "use strict";
        ...
        function formatItems(iContext, oEntitySet, oSelectionVariant, oPresentationVariant, oDimensions, oMeasures, chartType) {
            ...
            if (oEntityType) {
                ...
                if (requestFields && requestFields.length > 0) {
                    jQuery.each(requestFields, function (i, r) {
            ...
            */
            ...
            jQuery.each(feeds, function(i, feed){
                ...
                if (feedType === "Measure"){
                    ...
                    jQuery.each(aFeedValueContexts, function(j, contextMeasure){
                ...
                if (currentFeedType === "Measure"){
                    ...
                    if (oVizPropertiesFeed && oVizPropertiesFeed.length){
                        ...
                        if (aPropertiesLabels && aPropertiesLabels.length){
                            ...
                            jQuery.each(aPropertiesLabels, function(i, propertyLabel){

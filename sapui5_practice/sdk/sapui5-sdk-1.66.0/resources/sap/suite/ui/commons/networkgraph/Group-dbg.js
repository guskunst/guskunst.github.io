...
sap.ui.define([
	...
	Group.prototype._renderHeader = function (mOptions) {
		...
		mOptions.renderManager.write(this._renderHtmlIcon(this.getCollapsed() ? EXPAND_ICON : COLLAPSE_ICON, "sapSuiteUiCommonsNetworkGroupHeaderMenuIcon", "collapse", sContentStyle));
		mOptions.renderManager.write(this._renderHtmlIcon(MENU_ICON, "sapSuiteUiCommonsNetworkGroupHeaderMenuIcon", "menu", sContentStyle));
		mOptions.renderManager.write("</div>");

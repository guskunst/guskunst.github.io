	...
	function(Device) {
		...
		var HANDLER_CLASSES = {
			...
			n: {
				...
				handlers: ["Horizontal"],
				types: ["Rectangle", "Custom", "Ellipse"]
			},
			s: {
				vertical: "sapSuiteUiCommonsImageEditorBottom",
				horizontal: "sapSuiteUiCommonsImageEditorCenter",
		...
		ImageEditorRenderer.renderSvgOverlay = function(oRm, oControl) {
			...
			oRm.write("<use href='#" + oControl.getId() + "-overlayMaskCustomBlack" + "' class='sapSuiteUiCommonsImageEditorCropItemCustom'/>");
			oRm.write("</mask>");
			...
			oRm.write("<use href='#" + oControl.getId() + "-overlayMaskCustomWhite" + "' class='sapSuiteUiCommonsImageEditorCropItemCustom'/>");
			oRm.write("</mask>");
			oRm.write("</defs>");
		...
		ImageEditorRenderer.renderRectBorders = function(oRm, oControl) {
			oRm.write("<g class='sapSuiteUiCommonsImageEditorCropItemRectangle sapSuiteUiCommonsImageEditorCropItemCustom'>");
		...
		ImageEditorRenderer.renderThirdLines = function(oRm, oControl) {
			oRm.write("<g mask='url(#" + oControl.getId() + "-thirdsMask)'>");

    ...
    var SchedulingAgent = {
        ...
        _processStepConfiguration: function (loadingStepConfiguration) {
            ...
            if (loadingStepConfiguration.oConfig.loadingMode === oLoadingModes.CONTINUE_ON_EVENT) {
                ...
                // TODO: pass the name of the step to the component being loaded, to allow it
                // to return the correct name to StepDone and don't make this a configuration
                // problem
                //oStepConfig.oData.eventData.sStepName = loadingStepConfiguration.oContent.LoadingStep;
            ...
            do {
                ...
                if (oNextStep.sStatus === oStatusDefinitions.STEP) {
                    ...
                    if (!oStepConfig.bConfigOk) {
                        ...
                        state.setForLoadingStep(oStepConfig.sStepName, state.id.loadingStep.InProgress, oStepConfig.oData.eventName, "Step sent to Event Processor");
                    } else if (oStepConfig.sStepType === oLoadingModes.BY_EVENT) {
                        FLPLoader.loadComponentByEvent(oStepConfig.oData);
                        state.setForLoadingStep(oStepConfig.sStepName, state.id.loadingStep.InProgress, oStepConfig.oData, "Step sent to FLP Loader");

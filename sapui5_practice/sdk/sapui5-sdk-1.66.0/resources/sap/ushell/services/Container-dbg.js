...
function (utils, System, oUi5ServiceFactory, Ui5NativeServiceFactory, EventProvider, ServiceFactoryRegistry, ServiceFactory, Control, jQuery) {
    "use strict";
    /*global close, document, OData, sap, setTimeout, window */
    ...
    /**
     * Creates and registers ui5services. The service is created via service factory
     * so that its creation is deferred until the service is used.
     *
     * @param {string[]} aServicesToRegister An array of service names to register.
     *
     * @private

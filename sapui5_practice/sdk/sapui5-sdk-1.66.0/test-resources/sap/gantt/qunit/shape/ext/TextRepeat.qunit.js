...
sap.ui.define([
	...
	QUnit.test("Test getter method of TextRepeat class.", function (assert) {
		...
		assert.strictEqual(this.oTextRepeat.getContent(this.oData, this.oRowInfo),
			"<pattern id='activity_01' patternUnits='userSpaceOnUse' width=200 height=16 x=1035 y=0><text dx=0 dy=1.2em font-size=12 font-family=''>Activity 01</text></pattern>");
	});
});

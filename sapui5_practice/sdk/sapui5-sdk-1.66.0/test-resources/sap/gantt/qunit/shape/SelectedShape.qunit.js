...
sap.ui.define([
	...
	QUnit.test("Test default value of get<Property>() methods.", function (assert) {
		assert.strictEqual(this.oSelectedShape.getD(this.oData, this.oRowInfo), "M 405 16 c 0,-7.5 7.5,-7.5 7.5,0 c 0,7.5 7.5,7.5 7.5,0");
		assert.strictEqual(this.oSelectedShapeRect.getD(this.oData, this.oRowInfo), "M 404 7.5 L 924 7.5 L 924 24.5 L 404 24.5 z");
		assert.strictEqual(this.oSelectedShapeGroup.getD(this.oData, this.oRowInfo), "M 405 8.5 L 924 8.5 L 924 23.5 L 405 23.5 z");
		assert.strictEqual(this.oSelectedShapePoly.getD(this.oData, this.oRowInfo), "M 390 16 L 395 16 L 400 8.5 L 410 23.5 L 415 16 L 420 16");
		assert.strictEqual(this.oSelectedShapeLine.getD(this.oData, this.oRowInfo), "M 404 15 L 925 15 L 925 18 L 404 18 z");
		assert.strictEqual(this.oSelectedShapeCircle.getD(this.oData, this.oRowInfo), "M 405 16 A 5 5, 0, 1, 1, 405 16");
	...
	QUnit.test("Test configured value of get<Property>() methods.", function (assert) {
		assert.strictEqual(this.oSelectedShape.getD(this.oData, this.oRowInfo), "M 405 16 c 0,-259 259,-259 259,0 c 0,259 259,259 259,0");
		assert.strictEqual(this.oSelectedShapeGroup.getD(this.oData, this.oRowInfo), "M 405 1 L 410 1 L 410 16 L 405 16 z");
		assert.strictEqual(this.oSelectedShape.getStroke(this.oData, this.oRowInfo), "red");
		assert.strictEqual(this.oSelectedShape.getStrokeWidth(this.oData, this.oRowInfo), 2);
	});

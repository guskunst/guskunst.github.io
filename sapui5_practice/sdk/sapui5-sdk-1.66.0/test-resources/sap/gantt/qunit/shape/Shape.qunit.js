...
sap.ui.define([
	...
	QUnit.test("Test configured value of get<Property>() methods.", function (assert) {
		...
		assert.strictEqual(this.oShape.getTransform(this.oData, this.oRowInfo), "translate(40 50) rotate(30 248 78)");
		...
		assert.strictEqual(this.oShape.getRotationCenter(this.oData, this.oRowInfo).join(", "), "248, 78");

...
sap.ui.define([
	...
	QUnit.test("Test default value of get<Property>() methods.", function (assert) {
		assert.strictEqual(this.oPolygon.getPoints(this.oData, this.oRowInfo),
			"466.0717967697245,12 473,8 479.9282032302755,12 479.9282032302755,20 473,24 466.0717967697245,20",

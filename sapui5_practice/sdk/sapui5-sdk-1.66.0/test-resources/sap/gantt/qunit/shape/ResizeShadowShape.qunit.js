...
sap.ui.define([
	...
	QUnit.test("Resize shadow shape under different shapes", function (assert) {
		//path
		assert.strictEqual(this.oResizeShadowShapePath.getD(this.oData, this.oRowInfo), "M 405 16 c 0,-7.5 7.5,-7.5 7.5,0 c 0,7.5 7.5,7.5 7.5,0", "Resize shadow shape for <Path> works fine.");
		...
		//group
		assert.strictEqual(this.oResizeShadowShapeGroup.getD(this.oData, this.oRowInfo), "M 405 7.5 L 924 7.5 L 924 22.5 L 405 22.5 z", "Resize shadow shape for <Group> works fine.");
		//rectangle
		assert.strictEqual(this.oResizeShadowShapeRect.getD(this.oData, this.oRowInfo), "M 404 7.5 L 924 7.5 L 924 24.5 L 404 24.5 z", "Resize shadow shape for <Rectangle> works fine.");
		//line
		assert.strictEqual(this.oResizeShadowShapeLine.getD(this.oData, this.oRowInfo), "M 404 15 L 925 15 L 925 18 L 404 18 z", "Resize shadow shape for <Line> works fine.");
		//image
		assert.strictEqual(this.oResizeShadowShapeImage.getD(this.oData, this.oRowInfo), "M 394 5 L 416 5 L 416 27 L 394 27 z", "Resize shadow shape for <Image> works fine.");
		//polygon
		assert.strictEqual(this.oResizeShadowShapePolygon.getD(this.oData, this.oRowInfo), "M 398.0717967697245 12 L 405 8 L 411.9282032302755 12 L 411.9282032302755 20 L 405 24 L 398.0717967697245 20 z", "Resize shadow shape for <Polygon> works fine.");
		//polyline
		assert.strictEqual(this.oResizeShadowShapePolyline.getD(this.oData, this.oRowInfo), "M 390 16 L 395 16 L 400 8.5 L 410 23.5 L 415 16 L 420 16", "Resize shadow shape for <Polyline> works fine.");
		//circle
		assert.strictEqual(this.oResizeShadowShapeCircle.getD(this.oData, this.oRowInfo), "M 405 16 A 5 5, 0, 1, 1, 405 16", "Resize shadow shape for <Circle> Cx works fine.");
	});
});

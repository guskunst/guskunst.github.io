...
sap.ui.define([
	...
	QUnit.test("Test function reference", function (assert) {
		...
		assert.ok(this.oTable._updateTableContent !== undefined, "_updateTableContent function exists");
	...
	QUnit.test("Test variable reference", function (assert) {
		...
		assert.ok(this.oTable._oSelectionPlugin !== undefined, "_oSelectionPlugin variable exists");
	});

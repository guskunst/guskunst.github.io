...
sap.ui.define([
	...
	QUnit.test("Cursor postions", function(assert){
	...
	QUnit.test("auto scroll left", function(assert) {
		...
		this.delayedAssert(function() {
			...
			this.delayedAssert(function() {
				...
				this.delayedAssert(function(){
					var mSvgCtn2 = that.getSvgCtn();
					assert.ok(iScrollLeftHistory > mSvgCtn2.hsb.scrollLeft(), "auto scroll to left correctly!");
					this.mouseup(document.body, iMoveX, iMoveY);
					done();
				}.bind(this));
			}.bind(this));

sap.ui.define([
	...
	QUnit.test("Swimlane algorithm doesn't put nipples between collapsed groups.", function (assert) {
		var oGraph = GraphTestUtils.buildGraph({
				nodes: [
			...
			oLine0 = oGraph.getLines()[0],
			fnAssert = function () {
				assert.equal(oLine0._aNipples.length, 0, "There should be NO nipples on the only line.");
			},
			fnDone = assert.async();

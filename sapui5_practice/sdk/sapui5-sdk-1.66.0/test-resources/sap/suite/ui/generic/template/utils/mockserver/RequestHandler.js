sap.ui.define(["jquery.sap.global", "sap/ui/base/Object", "../Utils"], function(jQuery, BaseObject, Utils) {
	"use strict";
	...
	return BaseObject.extend("test.sap.suite.ui.generic.template.utils.mockserver.RequestHandler", {
		constructor: function(sComponentId, sBaseURL, oMockServer) {
			jQuery.extend(this, getMethods(sComponentId, sBaseURL, oMockServer));
		}
	});
});

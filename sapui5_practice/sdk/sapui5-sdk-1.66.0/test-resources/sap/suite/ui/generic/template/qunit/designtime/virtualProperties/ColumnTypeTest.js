...
sap.ui.define([
	...
	function(sinon, ChangeHandlerUtils, AnnotationHelper, ColumnType, DesigntimeUtils) {
		...
		QUnit.test("setColumnType: old = new", function() {
			...
			// Act
			var aChangeContent = ColumnType.setColumnType(this.oColumn, COLUMNTYPE_DATAFIELDFORACTION);
		...
		QUnit.test("setColumnType from DataFieldForAction to Datafield", function() {
			...
			// Act
			var aChangeContent = ColumnType.setColumnType(this.oColumn, COLUMNTYPE_DATAFIELD);
		...
		QUnit.test("setColumnType from DataField to DataFieldWithIntentBasedNavigation ", function() {
			...
			// Act
			var aChangeContent = ColumnType.setColumnType(this.oColumn, COLUMNTYPE_INTENTBASEDNAV);
		...
		QUnit.test("setColumnType from DataField to DataFieldForIntentBasedNavigation", function() {
			...
			// Act
			var aChangeContent = ColumnType.setColumnType(this.oColumn, COLUMNTYPE_FORINTENTBASEDNAV);
		...
		QUnit.test("setColumnType from DataField to DataFieldWithNavigationPath", function() {
			...
			// Act
			var aChangeContent = ColumnType.setColumnType(this.oColumn, COLUMNTYPE_DATAFIELDWITHNAVPATH);
		...
		QUnit.test("setColumnType from DataFieldForAction to DatafieldWithUrl", function() {
			...
			// Act
			var aChangeContent = ColumnType.setColumnType(this.oColumn, COLUMNTYPE_DATAFIELDWITHURL);
		...
		QUnit.test("setColumnType from DataFieldForAction to Chart", function() {
			...
			// Act
			var aChangeContent = ColumnType.setColumnType(this.oColumn, COLUMNTYPE_CHART);
				...
				"MyEntityType": {
					"com.sap.vocabularies.UI.v1.Chart": {
						...
						"MeasureAttributes": [
							{
								"DataPoint": {
									"AnnotationPath": "@com.sap.vocabularies.UI.v1.DataPoint#Chart"
								},
								"Measure": {
									"PropertyPath": ""
								},
			...
			var oNewDataPoint = {
				"MyEntityType": {
					"com.sap.vocabularies.UI.v1.DataPoint#Chart": {
			...
			assert.deepEqual(aChangeContent[1].content.newValue, oNewDataPoint, "returns right new content after a switch from action to chart at position 1");
			assert.deepEqual(aChangeContent[2].content.newValue, oNewRecord , "returns right new content after a switch from action to chart at position 1");
		...
		QUnit.test("setColumnType from DataFieldForAction to Contact", function() {
			...
			// Act
			var aChangeContent = ColumnType.setColumnType(this.oColumn, COLUMNTYPE_CONTACT);
		...
		QUnit.test("setColumnType to Rating, no Datapoint yet", function() {
			...
			// Act
			var aChangeContent = ColumnType.setColumnType(this.oColumn, COLUMNTYPE_RATING);
					...
					"com.sap.vocabularies.UI.v1.LineItem": [
						{
							...
							RecordType: DATAFIELDFORANNOTATION,
							Target: {"AnnotationPath": "@" + DATAPOINT + "#Rating"},
							"com.sap.vocabularies.UI.v1.Importance": {
								EnumMember: HIGH_IMPORTANCE
							}
						}
		...
		QUnit.test("setColumnType to Progress, no Datapoint yet", function() {
			...
			// Act
			var aChangeContent = ColumnType.setColumnType(this.oColumn, COLUMNTYPE_PROGRESS);
					...
					"com.sap.vocabularies.UI.v1.LineItem": [
						{
							...
							RecordType: DATAFIELDFORANNOTATION,
							Target: {"AnnotationPath": "@" + DATAPOINT + "#Progress"},
							"com.sap.vocabularies.UI.v1.Importance": {
								EnumMember: HIGH_IMPORTANCE
							}
						}
		...
		QUnit.test("setColumnType to Connected Fields", function() {
			...
			var oNewColumnStub =  {
				...
				RecordType: DATAFIELDFORANNOTATION,
				Target: { AnnotationPath: "@" + FIELDGROUP + "#DTA" }
			};
			this.oCreateNewColumStub = sinon.stub(DesigntimeUtils, "createNewColumn").returns(oNewColumnStub);
			this.oGetLineItemRecordIndexStub = sinon.stub(ChangeHandlerUtils, "getLineItemRecordIndex").returns(1);
			this.oDataEntityTypeStub = {
			...
			// Act
			var aChangeContent = ColumnType.setColumnType(this.oColumn, COLUMNTYPE_CONNECTEDFIELDS);
					...
					"com.sap.vocabularies.UI.v1.LineItem": [
						{
							...
							RecordType: DATAFIELDFORANNOTATION,
							Target: { AnnotationPath: "@" + FIELDGROUP + "#DTAGroup" },
							"com.sap.vocabularies.UI.v1.Importance": {
								EnumMember: HIGH_IMPORTANCE
							}
						}
			...
			var oNewFieldGroup = {
				MyEntityType: {
					"com.sap.vocabularies.UI.v1.FieldGroup#DTAGroup": {
						"Data": [{
							"Value": {

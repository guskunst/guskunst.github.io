sap.ui.controller("STTA_MP.ext.controller.DetailsExtension", {
        ...
        var fnFunction = function (oEvent) {
            ...
            if(tableId === myId ) {
                oEvent.deleteEntitiesPromise.then(
                    function() { sap.m.MessageBox.success("Example of attachAfterLineItemDelete extension API"); },
                    function() { sap.m.MessageBox.error("Unsuccessful"); }
                ); 
            }  
        };
	...
	onMySmartChartHello: function() {
		...
		sap.m.MessageBox.success(aSelectedDataPoints.count + " DataPoints have been selected.", {});
	},
	...
	onFormButtonPressed: function() {
		sap.m.MessageBox.success("Hello from SmartForm breakout!", {});
	},
	...
	onGridTableBreakoutButtonPress: function() {
		sap.m.MessageBox.success("Hello from onGridTableBreakoutButtonPress breakout!", {});
	},
	onAnalyticalTableBreakoutButtonPress: function() {
		sap.m.MessageBox.success("Hello from onAnalyticalTableBreakoutButtonPress breakout!", {});
	},
	...
	customizeMsgModelforTransientMessagesExtension:function() {
		if(sap.ui.getCore().getMessageManager().getMessageModel().oData.length) {
			return new Promise(function(resolve,reject) {
				...
				var InfoMessage = new sap.ui.core.message.Message({
					message: msgText,
					description: msgDesc,

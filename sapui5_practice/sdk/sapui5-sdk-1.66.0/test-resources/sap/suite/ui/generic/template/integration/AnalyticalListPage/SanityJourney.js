...
sap.ui.define(["sap/ui/test/opaQunit"], function() {
	...
	opaTest("Single Selection in VF Chart", function(Given, When, Then) {
		...
		Then.onTheMainPage.checkTableRowCount(1);
	...
	opaTest("Others Selection in Donut Chart",function(Given,When,Then){
		...
		Then.onTheMainPage.checkTableRowCount(7);
	});
	...
	//	Then.onTheMainPage.iCheckKpiTagTooltip(0, "Actual Cost 2,000.00 EUR ", "Good");  //commenting till setapi of generic tag is fixed
		Then.onTheMainPage.iCheckKpiScaleFactor(0,"K");
		Then.onTheMainPage.iCheckNumberofFractionalDigit(0,1);
	});

	opaTest("KPI Card Title",function(Given,When,Then){
		When.onTheMainPage.iClickTheKPI(0);
	...
	opaTest("Check for mandatory fields missing info message for KPI entityset different than main entityset with matching fields", function (Given, When, Then) {
		...
		When.onTheMainPage.iClickTheKPI(4);
	...
	opaTest("Apply Filters on Filterable KPIs and check the values",function(Given,When,Then){
		...
		Then.onTheMainPage.iCheckKpiValue(3,"309.8K");
		Then.onTheMainPage.iCheckKpiScaleFactor(3,"K");
		Then.onTheMainPage.iCheckNumberofFractionalDigit(3,1);
		...
		Then.onTheFilterBar.iCloseTheVHDialog();
		Then.onTheMainPage.iCheckKpiValue(3,"2.6M");
		Then.onTheMainPage.iCheckKpiScaleFactor(3,"M");
		Then.onTheMainPage.iCheckNumberofFractionalDigit(3,1);

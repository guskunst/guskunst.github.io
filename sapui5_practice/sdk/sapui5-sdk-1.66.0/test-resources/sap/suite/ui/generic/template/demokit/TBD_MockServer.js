sap.ui.define([
	...
	function(MockServer, DraftEnabledMockServer) {
		"use strict";
						...
						if (typeof dataSource.type === "undefined" || dataSource.type === "OData") {
							...
							aRequests.push({
								...
								response: function(oXhr, sPre, sDraftUUID, sIsActiveEntity, sAfter) {
									...
									oSiblingEntity = jQuery.sap.sjax({
							...
							aRequests.push({
								...
								response: function(oXhr, sPre, sIsActiveEntity, sAfter) {
									...
									var sJsonFilesUrl = jQuery.sap.getModulePath(sJsonFilesModulePath);
									var oDraftResponse = jQuery.sap.sjax({

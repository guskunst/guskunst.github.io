...
sap.ui.define(
	...
	function(VisualFilterProvider, SmartVisualFilterBar, JSONModel, sinon) {
		"use strict";
		...
		oConfig = jQuery.sap.syncGetJSON(sConfigUrl).data,
		oVariantConfig = jQuery.sap.syncGetJSON(sVariantConfigUrl).data,
		oSandbox,
		oAnnotationSettings;

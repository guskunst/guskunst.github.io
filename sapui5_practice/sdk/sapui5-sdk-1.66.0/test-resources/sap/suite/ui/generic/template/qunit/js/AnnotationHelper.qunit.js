sap.ui.define(["sap/ui/core/UIComponent",
	...
	"tests/AnnotationHelper-determineTableType",
...
], function (UIComponent, Log, AnnotationHelper, TemplateComponent, MockServer, Interface) {
	...
	QUnit.test("check: object page selection mode", function () {
		...
		result = oAnnotationHelper.getSelectionModeGridTable(aEntities, sRootEntitySet, oManifestExt_Multi, oFacet, oEntitySet, oPagesDetailNo);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //1.
		result = oAnnotationHelper.getSelectionModeGridTable(aEntities, sRootEntitySet, oManifestExt_Single, oFacet, oEntitySet, oPagesDetailNo);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //2.
		result = oAnnotationHelper.getSelectionModeGridTable(aEntities, sRootEntitySet, oManifestExt_Action, oFacet, oEntitySet, oPagesDetailNo);
		assert.equal(result, "Single"); //3.
		result = oAnnotationHelper.getSelectionModeGridTable(aEntities, sRootEntitySet, oManifestExt_SelectionFalse, oFacet, oEntitySet, oPagesDetailNo);
		...
		result = oAnnotationHelper.getSelectionModeTreeTable(aEntities, sRootEntitySet, oManifestExt_Multi, oFacet, oEntitySet, oPagesDetailNo);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //9.
		result = oAnnotationHelper.getSelectionModeTreeTable(aEntities, sRootEntitySet, oManifestExt_Single, oFacet, oEntitySet, oPagesDetailNo);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //10.
		result = oAnnotationHelper.getSelectionModeTreeTable(aEntities, sRootEntitySet, oManifestExt_Action, oFacet, oEntitySet, oPagesDetailNo);
		assert.equal(result, "Single"); //11.
		result = oAnnotationHelper.getSelectionModeTreeTable(aEntities, sRootEntitySet, oManifestExt_SelectionFalse, oFacet, oEntitySet, oPagesDetailNo);

		//getSelectionModeAnalyticalTable
		result = oAnnotationHelper.getSelectionModeAnalyticalTable(aEntities, sRootEntitySet, oManifestExt_Multi, oFacet, oEntitySet, oPagesDetailNo);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //12.
		result = oAnnotationHelper.getSelectionModeAnalyticalTable(aEntities, sRootEntitySet, oManifestExt_Single, oFacet, oEntitySet, oPagesDetailNo);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //13.
		result = oAnnotationHelper.getSelectionModeAnalyticalTable(aEntities, sRootEntitySet, oManifestExt_Action, oFacet, oEntitySet, oPagesDetailNo);
		assert.equal(result, "Single"); //14.
		result = oAnnotationHelper.getSelectionModeAnalyticalTable(aEntities, sRootEntitySet, oManifestExt_SelectionFalse, oFacet, oEntitySet, oPagesDetailNo);

		// deletable entity sets (i.e. with DELETE action)
		result = oAnnotationHelper.getSelectionModeGridTable(aEntities, sRootEntitySet, oManifestExt_SelectionFalse, oFacet, oEntitySetDeletable, oPagesNoDetailNo, false);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //15.
		result = oAnnotationHelper.getSelectionModeGridTable(aEntities, sRootEntitySet, oManifestExt_SelectionFalse, oFacet, oEntitySetDeletable, oPagesNoDetailNo, true);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //16.
		result = oAnnotationHelper.getSelectionModeGridTable(aEntities, sRootEntitySet2, oManifestExt_SelectionFalse, oFacet, oEntitySetDeletableBoolTrue, oPagesDetailNo, true);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //17.
		result = oAnnotationHelper.getSelectionModeGridTable(aEntities, sRootEntitySet2, oManifestExt_SelectionFalse, oFacet, oEntitySet, oPagesDetailNo, true);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //18.
		result = oAnnotationHelper.getSelectionModeGridTable(aEntities, sRootEntitySet2, oManifestExt_SelectionFalse, oFacet, oEntitySetDeletablePath, oPagesDetailNo, true);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //19.

		//Tests for selection mode for deletable entity sets in tree-table
		result = oAnnotationHelper.getSelectionModeTreeTable(aEntities, sRootEntitySet, oManifestExt_SelectionFalse, oFacet, oEntitySetDeletable, oPagesNoDetailNo, false);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //20. 
		result = oAnnotationHelper.getSelectionModeTreeTable(aEntities, sRootEntitySet, oManifestExt_SelectionFalse, oFacet, oEntitySetDeletable, oPagesNoDetailNo, true);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //21.
		result = oAnnotationHelper.getSelectionModeTreeTable(aEntities, sRootEntitySet2, oManifestExt_SelectionFalse, oFacet, oEntitySetDeletableBoolTrue, oPagesDetailNo, true);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //22.
		result = oAnnotationHelper.getSelectionModeTreeTable(aEntities, sRootEntitySet2, oManifestExt_SelectionFalse, oFacet, oEntitySet, oPagesDetailNo, true);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //23.
		result = oAnnotationHelper.getSelectionModeTreeTable(aEntities, sRootEntitySet2, oManifestExt_SelectionFalse, oFacet, oEntitySetDeletablePath, oPagesDetailNo, true);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //24.
		...
		assert.equal(result, "{= !${ui>/editable} ? 'SingleSelectLeft' : 'None' }"); //25.
		...
		assert.equal(result, "{= !${ui>/editable} ? 'SingleSelectLeft' : 'None' }"); //26.
		...
		assert.equal(result, "{= !${ui>/editable} ? 'SingleSelectLeft' : 'None' }"); //27.
		...
		assert.equal(result, "{= !${ui>/editable} ? 'SingleSelectLeft' : 'None' }"); //28.
		...
		assert.equal(result, "{= !${ui>/editable} ? 'SingleSelectLeft' : 'None' }"); //29.

		result = oAnnotationHelper.getSelectionModeAnalyticalTable(aEntities, sRootEntitySet, oManifestExt_SelectionFalse, oFacet, oEntitySetDeletable, oPagesDetailNo, false);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //30.
		result = oAnnotationHelper.getSelectionModeAnalyticalTable(aEntities, sRootEntitySet, oManifestExt_SelectionFalse, oFacet, oEntitySetDeletable, oPagesDetailNo, true);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //31.
		result = oAnnotationHelper.getSelectionModeAnalyticalTable(aEntities, sRootEntitySet, oManifestExt_SelectionFalse, oFacet, oEntitySetDeletableBoolTrue, oPagesDetailNo, true);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //32.
		result = oAnnotationHelper.getSelectionModeAnalyticalTable(aEntities, sRootEntitySet, oManifestExt_SelectionFalse, oFacet, oEntitySet, oPagesDetailNo, true);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //33.
		result = oAnnotationHelper.getSelectionModeAnalyticalTable(aEntities, sRootEntitySet, oManifestExt_SelectionFalse, oFacet, oEntitySetDeletablePath, oPagesDetailNo, true);
		assert.equal(result, "{= !${ui>/editable} ? 'Single' : 'None' }"); //34.
	});

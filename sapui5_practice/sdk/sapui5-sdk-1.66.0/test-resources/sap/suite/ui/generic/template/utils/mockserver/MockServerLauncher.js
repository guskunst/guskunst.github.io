sap.ui.define(["jquery.sap.global", 'sap/ui/core/util/MockServer', "./RequestHandler", "./SalesOrderPushFunctions",
		"./ProductPushFunctions", "./PushFunctions", "../Utils", "sap/ui/fl/FakeLrepConnectorLocalStorage"],
	function(jQuery, MockServer, RequestHandler, SalesOrderPushFunctions, ProductPushFunctions, PushFunctions, Utils, FakeLrepConnectorLocalStorage) {
		"use strict";
...
*/		
		...
		function startMockServers(appPath, manifest, sComponentId, iAutoRespond) {
					...
					if (dataSource.settings && dataSource.settings.localUri) {
						if (typeof dataSource.type === "undefined" || dataSource.type === "OData") {
							...
							if (manifest["sap.ui.generic.app"] &&
								...
								ProductPush(aRequests, oMockServer);
							} else {
...
/*						oMockServer.attachAfter("GET", function (obj) {
							...
							console.log(jQuery.extend(true, {}, obj));

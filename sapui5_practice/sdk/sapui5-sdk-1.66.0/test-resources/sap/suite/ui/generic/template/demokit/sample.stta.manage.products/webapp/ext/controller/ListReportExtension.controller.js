sap.ui.controller("STTA_MP.ext.controller.ListReportExtension", {
	...
	onInit: function() {
		...
		sap.ui.require(["sap/ui/generic/app/navigation/service/NavigationHandler"], function(NavigationHandler) {
...
//		debugger;
		...
		if (oSmartFilterBar instanceof sap.ui.comp.smartfilterbar.SmartFilterBar) {
			...
			if (oCustomControlWeight instanceof sap.m.ComboBox) {
				var vTShirtSize = oCustomControlWeight.getSelectedKey();
				switch (vTShirtSize) {
					case "0" :
						oBindingParams.filters.push(new sap.ui.model.Filter("Weight", "LE", "1"));
						break;
					case "1" :
						oBindingParams.filters.push(new sap.ui.model.Filter("Weight", "BT", "1", "2"));
						break;
					case "2" :
						oBindingParams.filters.push(new sap.ui.model.Filter("Weight", "BT", "2", "3"));
						break;
					case "3" :
						oBindingParams.filters.push(new sap.ui.model.Filter("Weight", "GT", "3"));
						break;
					default :
						break;
				}
					...
					beginButton: new sap.m.Button({
						...
						press: function() {
							try {
								...
								sap.m.MessageBox.error("TransactionController for ListReport currently not supported - action cannot be completed", {});
								oParameterDialog.close();
								that.handleError(ex, {
									context: oContext
								});
...
//		var oTable = oEvent.getSource().getParent().getParent().getTable();
		...
		//sap.m.MessageBox.success("Plus was pressed", {});
	},
	...
	onGlobalAction: function(oEvent){
		sap.m.MessageBox.success("Global Action triggered", {});
	},

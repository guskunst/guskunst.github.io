...
sap.ui.define([
	...
	function (sinon, Utils, Button, AnnotationHelperForDesignTime) {
		"use strict";
		...
		/*
		The stub of the AnnotationHelper is not working as expected. This needs to be investigated before
		we can enable the tests.
		 */
		...
		//
		// 	// Assert
		// 	assert.equal(oEntityType, this.oDataEntityTypeStub, "returns the ODataEntityType as defined in Object Page when table does not have navigation path");
		//
		// 	this.oGetModelStub.restore();
		// 	this.oComponentStub.restore();
		...
		//
		// 	// Assert
		// 	assert.equal(oEntityType, this.oDataEntityTypeStub, "returns the ODataEntityType as defined in Object Page when table has navigation path");
		//
		// 	this.oGetModelStub.restore();
		// 	this.oComponentStub.restore();
		// 	this.oGetSmartTableControlStub.restore();
		...
		QUnit.test("createFieldGroupTerm", function() {
			...
			// Assert
			assert.equal(sTerm, "com.sap.vocabularies.UI.v1.FieldGroup#RTAGroup4", "returns the right term if RTA groups are listed in wrong order");
		});
		...
		/*
		The stub of the AnnotationHelper is not working as expected. This needs to be investigated
		before we can enable the tests
		 */
		// QUnit.test("getLineItems", function() {
		// 	// Arrange
		// 	var oElementStub = {
		...
		QUnit.test("move Subsection from section containing subsection to section without having subsection", function(){
			...
			//Assert
			assert.ok(oCreateCollectionFacetsSpy.calledTwice, "Facet moved and normalized with collection facet to be rendered as subsection in ObjectPage");
			oGetODataEntityTypeStub.restore();
		...
		QUnit.test("move Subsection from section having mulitple subsection to other section having multiple subsection", function(){
			...
			Utils.fnMoveSubSection(oSourceSectionStub,oTargetSectionStub,1,0,aAnnotations);
			//Assert
			assert.ok(!oCreateCollectionFacetsSpy.called, "Facet moved and normalized with collection facet to be rendered as subsection in ObjectPage");
			oGetODataEntityTypeStub.restore();
			oCreateCollectionFacetsSpy.restore();
		...
		QUnit.test("getLineItemRecordForButton", function() {
			...
			// Assert
			assert.deepEqual(oEntry, {Value: {Path: "Column1Property"}}, "returns the first button");
		...
		QUnit.test("getLineItemRecordForButton", function() {
			...
			// Assert
			assert.deepEqual(oEntry, {Value: {Path: "Column2Property"}}, "returns the second button");
		...
		QUnit.test("getTemplatingInfo", function() {
			...
			// Assert
			assert.deepEqual(oTemplatingInfo, { bla: "bla" }, "returns the annotation information");
		});
		...
		QUnit.test("getODataPath", function() {
			...
			// Assert
			assert.equal(sODataPath, "ns.MyEntityType/com.sap.vocabularies.UI.v1.SelectionFields/3", "returns the right path for a selection field");
		});
		...
		QUnit.test("getODataPath", function() {
			...
			// Assert
			assert.equal(sODataPath, "ns.MyEntityType/com.sap.vocabularies.UI.v1.SelectionFields/3/UI.Importance", "returns the right path for a term with target");
		});
		...
		QUnit.test("getODataPath", function() {
			...
			// Assert
			assert.equal(sODataPath, "ns.MyEntityType/com.sap.vocabularies.UI.v1.SelectionFields/3", "returns the right path for a complex type without target");
		});
		...
		QUnit.test("getODataPath", function() {
			...
			// Assert
			assert.equal(sODataPath, "ns.MyEntityType/com.sap.vocabularies.UI.v1.Facets/0/Facets/0", "returns the right path for a object page sub-section");
		});
		...
		QUnit.test("getODataPath", function() {
			...
			// Assert
			assert.equal(sODataPath, "ns.MyEntityType/com.sap.vocabularies.UI.v1.Facets/0/Facets/0/Facets/1", "returns the right path for a object page field group");
		});
		/*
                QUnit.test("getODataPath", function() {
                    // Arrange
		...
		QUnit.test("getEntityTypeFromAnnotationPath", function() {
			...
			var oElement = {
				...
				oEntityTypeStub = {entityType: "MyEntityType"},
		...
		/*
		The stub of the AnnotationHelper is not working as expected. This needs to be investigated
		before we can enable the test
		 */
		// QUnit.test("getEntityTypeFromAnnotationPath", function() {
		// 	// Arrange
		// 	var oEntityTypeStub = {entityType: "OtherEntityType"},
		// 		oElement = {
		// 			getModel: function() {
		// 				return {
		// 					getMetaModel: function() {
		...
		QUnit.module("The function getHeaderFacetIndex",{
			...
			beforeEach: function() {
				...
				this.sFirstHeaderFacetID = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--header::headerEditable::com.sap.vocabularies.UI.v1.DataPoint::WeightUnit::BeforeReferenceExtension";
				this.sSecondHeaderFacetID = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::SEPMRA_C_PD_Product--header::headerEditable::com.sap.vocabularies.UI.v1.DataPoint::WeightUnit::DataPoint";
				this.sFacetID = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::SEPMRA_C_PD_Product--header::headerEditable::com.sap.vocabularies.UI.v1.DataPoint::WeightUnit::DataPoint";
				var that = this;
				this.aHeaderFacets = [
					{
						getId: function() {
				...
				this.aAnnotations = [
					{Label: "HeaderFacet1", Target: "DataPoint1"},
					{Label: "HeaderFacet2", Target: "DataPoint2"}
				];
		...
		QUnit.test("getHeaderFacetIndex", function() {
			...
			//Assert
			assert.equal(this.oGetIndexFromInstanceMetadataPathStub.calledWith(this.oControl), true, "The function getIndexFromInstanceMetadataPath called with the correct control if templating info exists");
			//Clean
			this.oTemplatingInfoStub.restore();
		...
		QUnit.test("getHeaderFacetIndex", function() {
			//Arrange
			this.sFacetID = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--header::headerEditable::com.sap.vocabularies.UI.v1.DataPoint::WeightUnit::BeforeReferenceExtension";
			var sExpectedId = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::SEPMRA_C_PD_Product--header::headerEditable::com.sap.vocabularies.UI.v1.DataPoint::WeightUnit::DataPoint";
			...
			Utils.getHeaderFacetIndex(this.oControl);
			//Assert
			assert.equal(this.oGetIndexFromInstanceMetadataPathStub.lastCall.args[0].getId(), sExpectedId, "The function getIndexFromInstanceMetadataPath called with the correct control in case of before facet header extension in standard header");
			//Clean
			this.oTemplatingInfoStub.restore();
			this.oGetIndexFromInstanceMetadataPathStub.restore();
		});
		...
		QUnit.test("getHeaderFacetIndex", function() {
			...
			Utils.getHeaderFacetIndex(this.oControl);
			//Assert
			assert.equal(this.oGetIndexFromInstanceMetadataPathStub.lastCall.args[0].getId(), sExpectedId, "The function getIndexFromInstanceMetadataPath called with the correct control in case of before facet header extension in dynamic header");
			//Clean
			this.oTemplatingInfoStub.restore();
			this.oGetIndexFromInstanceMetadataPathStub.restore();
		});
		...
		QUnit.test("getHeaderFacetIndex", function() {
			//Arrange
			this.sFacetID = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--header::headerEditable::com.sap.vocabularies.UI.v1.DataPoint::WeightUnit::AfterReferenceExtension";
			this.sFirstHeaderFacetID = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::SEPMRA_C_PD_Product--header::headerEditable::com.sap.vocabularies.UI.v1.DataPoint::WeightUnit::DataPoint";
			this.sSecondHeaderFacetID = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--header::headerEditable::com.sap.vocabularies.UI.v1.DataPoint::WeightUnit::AfterReferenceExtension";
			...
			Utils.getHeaderFacetIndex(this.oControl);
			//Assert
			assert.equal(this.oGetIndexFromInstanceMetadataPathStub.lastCall.args[0].getId(), sExpectedId, "The function getIndexFromInstanceMetadataPath called with the correct control in case of after facet header extension in standard header");
			//Clean
			this.oTemplatingInfoStub.restore();
			this.oGetIndexFromInstanceMetadataPathStub.restore();
		});
		...
		QUnit.test("getHeaderFacetIndex", function() {
			...
			Utils.getHeaderFacetIndex(this.oControl);
			//Assert
			assert.equal(this.oGetIndexFromInstanceMetadataPathStub.lastCall.args[0].getId(), sExpectedId, "The function getIndexFromInstanceMetadataPath called with the correct control in case of after facet header extension in dynamic header");
			//Clean
			this.oTemplatingInfoStub.restore();
			this.oGetIndexFromInstanceMetadataPathStub.restore();
		});
		...
		QUnit.test("getHeaderFacetIndex", function() {
			//Arrange
			this.sFacetID = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--AfterImageExtensionFacet::objectImage";
			...
			//Assert
			assert.equal(iIndex, 0, "The function getIndexFromInstanceMetadataPath called with the correct control in case of after image header extension");
			//Clean
			this.oTemplatingInfoStub.restore();
		});
		...
		QUnit.test("getHeaderFacetIndex", function() {
			//Arrange
			this.sFacetID = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--header::headerEditable::com.sap.vocabularies.UI.v1.DataPoint::WeightUnit::ReplaceReferenceExtension";
			this.sFirstHeaderFacetID = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--header::headerEditable::com.sap.vocabularies.UI.v1.DataPoint::WeightUnit::ReplaceReferenceExtension";
			this.sSecondHeaderFacetID = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::SEPMRA_C_PD_Product--header::headerEditable::com.sap.vocabularies.UI.v1.DataPoint::WeightUnit::DataPoint";
			...
			//Assert
			assert.equal(iIndex, iExpectedValue, "The function getIndexFromInstanceMetadataPath called with the correct control in case of replace facet header extension in standard header");
			//Clean
			this.oTemplatingInfoStub.restore();
		...
		QUnit.test("getHeaderFacetIndex", function() {
			...
			this.sFacetID = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--header::headerEditable::com.sap.vocabularies.UI.v1.DataPoint::WeightUnit::ReplaceReferenceExtension";
			this.sFirstHeaderFacetID = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::SEPMRA_C_PD_Product--header::headerEditable::com.sap.vocabularies.UI.v1.DataPoint::WeightUnit::DataPoint";
			this.sSecondHeaderFacetID = "TestProject::sap.suite.ui.generic.template.ObjectPage.view.Details::STTA_C_MP_Product--header::headerEditable::com.sap.vocabularies.UI.v1.DataPoint::WeightUnit::ReplaceReferenceExtension";
			var that = this;
			this.oParent = {
				getMetadata: function() {
					return {
			...
			var iIndex = Utils.getHeaderFacetIndex(this.oControl, this.aAnnotations);
			//Assert
			assert.equal(iIndex, iExpectedValue, "The function getIndexFromInstanceMetadataPath called with the correct control in case of replace facet header extension in dynamic header");
			//Clean
			this.oTemplatingInfoStub.restore();
		});
	});

...
sap.ui.define(
	["testUtils/sinonEnhanced", "sap/suite/ui/generic/template/AnalyticalListPage/util/AnnotationHelper", "sap/ui/model/json/JSONModel"],
	function(sinon, ALPHelper, JSONModel) {
		"use strict";
		var sMetaModelUrl = "test-resources/sap/suite/ui/generic/template/qunit/AnalyticalListPage/util/testdata/MetaModel.json",
			oMetaModel = jQuery.sap.syncGetJSON(sMetaModelUrl).data,

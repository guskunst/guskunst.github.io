sap.ui.define([
    ...
    "/sap/ovp/ui/DashboardLayoutUtil"
            ...
            test("Test to update layout data", function () {
                ...
                ok(this.dashboardLayoutUtil.oLayoutData.colCount === Math.floor(this.dashboardLayoutUtil.oLayoutData.contentWidthPx / this.dashboardLayoutUtil.MIN_COL_WIDTH_PX),

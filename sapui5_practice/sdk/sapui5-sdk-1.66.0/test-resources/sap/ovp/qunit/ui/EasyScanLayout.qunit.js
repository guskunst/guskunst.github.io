sap.ui.define([
...
],function (utils, mockservers, jquery, CommonUtils, EasyScanLayout, CustomData) {
    "use strict";
    ...
    test("EasyScan Layout - Ctrl-Arrow D&D Handle", function () {
        ...
        easyScan.onAfterRendering = function () {
            ...
            event.keyCode = jQuery.sap.KeyCodes.ARROW_RIGHT;
            keyboardNavigation.keydownHandler(event);
            event.keyCode = jQuery.sap.KeyCodes.END;
            keyboardNavigation.keydownHandler(event);
            ...
            event.ctrlKey = true;
            event.keyCode = jQuery.sap.KeyCodes.ARROW_LEFT;
            keyboardNavigation.keydownHandler(event);
            ...
            event.ctrlKey = false;
            event.keyCode = jQuery.sap.KeyCodes.CONTROL;
    ...
    test("EasyScan Layout - F6,F7 Handle", function () {
        ...
        easyScan.onAfterRendering = function () {
            ...
            event.preventDefault = function () {};
            event.keyCode = jQuery.sap.KeyCodes.F6;
            keyboardNavigation.keydownHandler(event);
            ...
            vBox.$().parent().focus();
            event.keyCode = jQuery.sap.KeyCodes.F7;
            event.shiftKey = false;
            keyboardNavigation.keydownHandler(event);

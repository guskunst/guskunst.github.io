...
sap.ui.define([
	"sap/ui/test/Opa5", "sap/ui/fl/FakeLrepConnectorLocalStorage", "sap/ui/fl/FakeLrepLocalStorage"
], function(Opa5, FakeLrepConnectorLocalStorage, FakeLrepLocalStorage) {
	"use strict";

	return Opa5.extend("sap.ui.mdc.qunit.base.info.opa.test.Arrangement", {
		...
		iEnableTheLocalLRep: function() {
			...
			// FakeLrepLocalStorage.saveChange("id_1539786688520_126_createItem", {
			...
			// 	}
			// });
			// FakeLrepLocalStorage.saveChange("id_1539786688556_128_revealItem", {
			...
			// 	}
			// });
			// FakeLrepLocalStorage.saveChange("id_1539787603700_135_createItem", {
			// 	changeType: "createItem",
			// 	conditions: {},
			// 	content: {
			...
			// 	}
			// });
			// FakeLrepLocalStorage.saveChange("id_1539787603730_137_revealItem", {
			// 	changeType: "revealItem",
			// 	conditions: {},
			// 	content: {},
			// 	context: "",
			...
			// 	}
			// });
			// FakeLrepLocalStorage.saveChange("id_1539787806268_146_createItem", {
			// 	changeType: "createItem",
			// 	conditions: {},
			// 	content: {
			...
			// 	}
			// });
			// FakeLrepLocalStorage.saveChange("id_1539787806295_148_revealItem", {
			// 	changeType: "revealItem",
			// 	conditions: {},
			// 	content: {},
			// 	context: "",
			...
			// 	}
			// });
			// FakeLrepLocalStorage.saveChange("id_1539787306073_160_createItem", {
			// 	changeType: "createItem",
			// 	conditions: {},
			// 	content: {
			...
			// 	}
			// });
			// FakeLrepLocalStorage.saveChange("id_1539787306095_162_revealItem", {
			// 	changeType: "revealItem",
			// 	conditions: {},
			// 	content: {},
			// 	context: "",

					...
					QUnit.test("Test fragment scope: " + index, function (assert) {
						return oMetaModel.requestObject("/$").then(function () {
							...
							var nsResolver = document.createNSResolver(oDocumentElement),
								...
								oElement = iElements.iterateNext(), sTestId, iNumberOfTestsPerformed = 0;
							...
							assert.equal(iNumberOfTestsPerformed, Object.keys(oScope.oExpectedResultsPerTest).length, "All tests have been executed for this test case");
						});
					});
				});
			}

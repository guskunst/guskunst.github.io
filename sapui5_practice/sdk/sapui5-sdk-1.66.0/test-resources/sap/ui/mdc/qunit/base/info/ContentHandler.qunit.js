...
sap.ui.require([
	"jquery.sap.global", "sap/ui/mdc/library", "sap/ui/mdc/base/Field", "sap/ui/mdc/flp/info/LinkHandler", "sap/ui/core/util/MockServer", "sap/ui/mdc/base/info/FakeFlpConnector", "sap/ui/model/odata/v2/ODataModel", "sap/ui/mdc/base/info/ContactDetails", "sap/ui/mdc/base/info/ContentHandler", "sap/ui/mdc/base/info/LinkHandler", "sap/ui/mdc/base/info/LinkItem", "sap/m/Button"
], function(jQuery, library, Field, FlpLinkHandler, MockServer, FakeFlpConnector, ODataModel, ContactDetails, ContentHandler, LinkHandler, LinkItem, Button) {
	"use strict";
	...
	QUnit.module("sap.ui.mdc.base.info.ContentHandler: API", {
		beforeEach: function() {
	...
	QUnit.module("sap.ui.mdc.base.info.ContentHandler: existenceOfContentChanged event", {
		beforeEach: function() {
	...
	QUnit.module("sap.ui.mdc.base.info.ContentHandler: visibility of items", {
		beforeEach: function() {

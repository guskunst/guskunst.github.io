...
sap.ui.require([
	"sap/ui/layout/library", "sap/ui/mdc/base/info/Panel", "sap/ui/mdc/base/info/PanelItem", "sap/ui/layout/form/SimpleForm", "sap/ui/core/Icon"
	...
	QUnit.module("sap.ui.mdc.base.info.Panel: API", {
		beforeEach: function() {
	...
	QUnit.module("sap.ui.mdc.base.info.Panel: display", {
		beforeEach: function() {
			this.oPanel;
		},
		afterEach: function() {
	...
	QUnit.module("sap.ui.mdc.base.info.Panel: visibility of items", {
		beforeEach: function() {
			this.oPanel;
		},
		afterEach: function() {
	...
	QUnit.module("sap.ui.mdc.base.info.Panel: default icon without main item", {
		beforeEach: function() {
			this.oPanel;
		},
		afterEach: function() {
	...
	QUnit.module("sap.ui.mdc.base.info.Panel: default icon with main item", {
		beforeEach: function() {
			this.oPanel;
		},
		afterEach: function() {
	...
	QUnit.module("sap.ui.mdc.base.info.Panel: open selection dialog", {
		beforeEach: function() {
			var oComponent = new sap.ui.core.Component();
			sinon.stub(sap.ui.fl.Utils, "getAppComponentForControl").returns(oComponent);
		},
		afterEach: function() {
			this.oPanel.destroy();
		}
	...
	QUnit.test("test 01", function(assert) {
		...
		sap.ui.getCore().loadLibrary('sap.ui.fl', {
			...
			setTimeout(function() {
				...
				assert.ok(this.oPanel.getDependents()[0].isA("sap.ui.mdc.base.info.SelectionDialog"));
				done();
			}.bind(this), 500);
		}.bind(this));
	});

...
sap.ui.define(
	[
		...
		"jquery.sap.global",
		"sap/ui/mdc/odata/v4/form/FormHelper",
		"sap/base/Log",
		"sap/ui/thirdparty/sinon-qunit"
	],
	function (sinon, jQuery, FormHelper, Log) {
		"use strict";
		...
		QUnit.test("Unit test to check checkIfCollectionFacetNeedsToBeRendered with partOfPreview", function (assert) {
			[{
				...
				partOfPreview: "true",
				bExpectedValue: true,
				sMessage: "ReferenceFacets with 'com.sap.vocabularies.UI.v1.PartOfPreview' as 'true' for some ReferenceFacet, and as 'false' for others"
			},{
				collectionFacet: {
					$Type: "com.sap.vocabularies.UI.v1.CollectionFacet",
					Facets: [{
				...
				partOfPreview: "false",
				bExpectedValue: true,
				sMessage: "ReferenceFacets with 'com.sap.vocabularies.UI.v1.PartOfPreview' as 'false' for some ReferenceFacets, and as 'true' for others"
			},{
				collectionFacet: {
					$Type: "com.sap.vocabularies.UI.v1.CollectionFacet",
					Facets: [{
				...
				partOfPreview: "true",
				bExpectedValue: true,
				sMessage: "ReferenceFacets with 'com.sap.vocabularies.UI.v1.PartOfPreview' as 'false' for one ReferenceFacet, and not available for others"
			},{
				collectionFacet: {
					$Type: "com.sap.vocabularies.UI.v1.CollectionFacet",
					Facets: [{
				...
				assert.equal(actualValue, oProperty.bExpectedValue, "Unit test to check checkIfCollectionFacetNeedsToBeRendered with partOfPreview: " + oProperty.partOfPreview + " and collectionFacet with " + oProperty.sMessage + " : ok");
			});
		});
		...
		QUnit.test("Unit test to check resolveAnnotationPathForForm for fomrs with navigation", function (assert) {
			...
			},
			{
				...
				path: "/Products/$Type/@com.sap.vocabularies.UI.v1.Facets/2/Target/$AnnotationPath",
				bExpectedValue: "/Products/$NavigationPropertyBinding/to_supplier/$NavigationPropertyBinding/to_department/@com.sap.vocabularies.UI.v1.Identification",
			...
			},
			{
				...
				assert.equal(actualValue, oProperty.bExpectedValue, "Unit test to check resolveAnnotationPathForForm " + oProperty.sAnnotationPathMessage + " : ok");
			});
		});
	}
);

...
sap.ui.define([
	...
	return CommonComponent.extend("appUnderTestChart.Component", {
		...
		init: function () {
			...
			FakeLrepLocalStorage.saveChange("id_1550048095839_52_Copy", {
				conditions: {},
				content: {
			...
			FakeLrepLocalStorage.saveChange("id_1550048095839_53_addItem", {
				changeType: "addItem",
				conditions: {},
				content: {
					index: 0,
				...
				texts: {},
				validAppVersions: {creation: "1.66.0", from: "1.66.0"},
				from: "1.66.0",
				variantReference: "id_1550048095839_52_Copy"
			});
			FakeLrepLocalStorage.saveChange("id_1550048095839_54_addItem", {
				changeType: "addItem",
				conditions: {},
				content: {
					index: 0,

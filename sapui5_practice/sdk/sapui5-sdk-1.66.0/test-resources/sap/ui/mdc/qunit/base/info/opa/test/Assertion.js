...
sap.ui.define([
	"sap/ui/test/Opa5", "sap/ui/core/library", "sap/ui/core/format/DateFormat", "sap/ui/mdc/qunit/base/info/opa/test/Util", "sap/ui/test/matchers/PropertyStrictEquals"
], function(Opa5, coreLibrary, DateFormat, TestUtil, PropertyStrictEquals) {
	"use strict";

	var Assertion = Opa5.extend("sap.ui.mdc.qunit.base.info.opa.test.Assertion", {
		...
		iShouldSeeOrderedLinksOnNavigationContainer: function(aTexts) {
			var oPanel;
			this.waitFor({
				controlType: "sap.ui.mdc.base.info.Panel",
				success: function(aPanels) {
		...
		contactInformationExists: function() {
			return this.waitFor({
				searchOpenDialogs: true,
				controlType: "sap.ui.mdc.base.info.ContactDetails",

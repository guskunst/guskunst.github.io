...
sap.ui.define([
	'sap/ui/test/Opa5', 'sap/ui/test/actions/Press', 'sap/ui/test/actions/EnterText', 'sap/ui/test/matchers/Properties', 'sap/ui/test/matchers/Ancestor', 'sap/ui/mdc/qunit/base/info/opa/test/Util', 'sap/ui/test/matchers/PropertyStrictEquals'
], function(Opa5, Press, EnterText, Properties, Ancestor, TestUtil, PropertyStrictEquals) {
	'use strict';

	var Action = Opa5.extend("sap.ui.mdc.qunit.base.info.opa.test.Action", {

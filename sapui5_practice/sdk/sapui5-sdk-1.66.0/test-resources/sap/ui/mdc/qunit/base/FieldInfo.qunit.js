...
sap.ui.define([
	"jquery.sap.global", "sap/ui/qunit/QUnitUtils", "sap/ui/Device", "sap/ui/mdc/library", "sap/ui/mdc/base/Field", "sap/ui/mdc/flp/info/LinkHandler", "sap/ui/core/util/MockServer", "sap/ui/mdc/base/info/FakeFlpConnector", "sap/ui/model/odata/v2/ODataModel", "sap/ui/mdc/base/info/ContactDetails", "sap/ui/mdc/base/FieldInfo", "sap/ui/mdc/base/info/LinkHandler", "sap/ui/mdc/base/info/LinkItem", "sap/ui/mdc/base/info/ContentHandler", "sap/m/Button"
	...
	QUnit.module("sap.ui.mdc.base.info.FieldInfo: API", {
		beforeEach: function() {
	...
	QUnit.module("sap.ui.mdc.base.info.FieldInfo: rendered as a text", {
		beforeEach: function() {
	...
	QUnit.module("sap.ui.mdc.base.info.FieldInfo: open direct navigation", {
		beforeEach: function() {
			startMockServer("test-resources/sap/ui/mdc/qunit/base/info/mockserver/metadata.xml", "test-resources/sap/ui/mdc/qunit/base/info/mockserver/", "/odataFake/");
			this.oODataModel = new ODataModel("/odataFake/");
			...
			dataUpdate: function() {
				...
				oField.getFieldInfo().getTriggerHref().then(function(sHref) {
					...
					setTimeout(function() {
						...
						assert.equal(oField.$().find("a")[0].href, "", "Href will be set in press event handler");
						assert.equal(sHref, "#action01");
						done();
					}, 100);
				});
			},
	...
	QUnit.module("sap.ui.mdc.base.info.FieldInfo: open empty popover", {
		beforeEach: function() {
			startMockServer("test-resources/sap/ui/mdc/qunit/base/info/mockserver/metadata.xml", "test-resources/sap/ui/mdc/qunit/base/info/mockserver/", "/odataFake/");
			this.oODataModel = new ODataModel("/odataFake/");
	...
	QUnit.module("sap.ui.mdc.base.info.FieldInfo: open not empty popover", {
		beforeEach: function() {
			startMockServer("test-resources/sap/ui/mdc/qunit/base/info/mockserver/metadata.xml", "test-resources/sap/ui/mdc/qunit/base/info/mockserver/", "/odataFake/");
			this.oODataModel = new ODataModel("/odataFake/");

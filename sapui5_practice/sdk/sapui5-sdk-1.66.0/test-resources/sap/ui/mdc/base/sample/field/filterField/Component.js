...
sap.ui.define([
	...
	var Component = UIComponent.extend("sap.ui.mdc.base.sample.field.filterField.Component", {
		metadata: {
			manifest: "json"
		},
		exit: function() {
		...
		init: function() {
			...
			var sPath = jQuery.sap.getModulePath("sap.ui.mdc.base.sample.field.localService");

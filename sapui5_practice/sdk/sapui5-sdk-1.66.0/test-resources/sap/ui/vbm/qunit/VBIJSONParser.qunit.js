...
sap.ui.define([
	...
	QUnit.test("Initial load", function(assert) {
		...
		assert.equal(context.resources.get("Cabin.dae").length, 47869, "Cabin.dae is parsed successfully.");
		assert.equal(context.resources.get("Axle.dae").length, 133814, "Axle.dae is parsed successfully.");
		assert.equal(context.resources.get("New_Frame_Transparent_2x2.png").length, 3238, "New_Frame_Transparent_2x2.png is parsed successfully.");
		assert.equal(context.resources.get("New_Cross_Frame_Transparent_2x2.png").length, 30818, "New_Cross_Frame_Transparent_2x2.png is parsed successfully.");

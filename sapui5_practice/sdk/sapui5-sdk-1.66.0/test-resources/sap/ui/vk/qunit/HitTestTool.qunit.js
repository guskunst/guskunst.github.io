...
sap.ui.define([
	...
	QUnit.test("Test 1", function(assert) {
		...
		var hit = tool.hitTest(10, 10, viewport.getScene(), viewport.getCamera(), sap.ui.vk.tools.HitTestClickType.Single);
		assert.ok(hit === null, "No objects detected");

		hit = tool.hitTest(viewport.getDomRef().clientWidth / 2, viewport.getDomRef().clientHeight / 2, viewport.getScene(), viewport.getCamera(), sap.ui.vk.tools.HitTestClickType.Single);

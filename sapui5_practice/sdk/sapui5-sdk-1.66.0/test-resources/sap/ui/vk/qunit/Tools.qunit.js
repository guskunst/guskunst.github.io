...
sap.ui.define([
	...
	QUnit.test("SceneOrientationTool", function(assert) {
		...
		viewport.attachEvent("viewFinished", function(evt){
			switch (phase){
				case 0:
					...
					sceneOrientationTool.setView(sap.ui.vk.tools.PredefinedView.Left);
				break;
				case 1:
					...
					sceneOrientationTool.setView(sap.ui.vk.tools.PredefinedView.Front, 100);
					time = Date.now();
				break;
				case 2:
					...
					sceneOrientationTool.setView(sap.ui.vk.tools.PredefinedView.Left, 100);
					time = Date.now();
					break;
				default:
		...
		sceneOrientationTool.setView(sap.ui.vk.tools.PredefinedView.Front);
	});

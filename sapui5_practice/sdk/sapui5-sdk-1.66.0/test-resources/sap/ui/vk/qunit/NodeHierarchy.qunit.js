...
sap.ui.define([
	...
	function testCreateNodeProxyDestroyNodeProxy(assert) {
		...
		assert.ok(nodeProxy instanceof sap.ui.vk.NodeProxy, "The node proxy object has been created.");
	...
	QUnit.moduleWithContentConnector("NodeHierarchy", "test-resources/sap/ui/vk/qunit/media/nodes_boxes.json", "threejs.test.json", function(assert) {
		...
		this.nodesCount = 28; // Need to update this unit test. We should not use hard code number of nodes as anyone can add more stuff to the current scene
	});

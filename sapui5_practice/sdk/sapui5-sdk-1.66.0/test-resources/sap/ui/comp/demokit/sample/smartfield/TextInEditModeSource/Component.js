sap.ui.define([
    ...
    return UIComponent.extend("sap.ui.comp.sample.smartfield.TextInEditModeSource.Component", {
        metadata: {
            rootView: {
                "viewName": "sap.ui.comp.sample.smartfield.TextInEditModeSource.SmartFieldTextInEditModeSource",
                "type": "XML",
                "async": true
            },
            dependencies: {
            ...
            config: {
                sample: {
                    stretch: true,
                    files: [
                        "SmartFieldTextInEditModeSource.view.xml",
                        "SmartFieldTextInEditModeSource.controller.js",
                        "Component.js",
        ...
        init: function () {
            ...
            this.oMockServer = new MockServer({
                rootUri: "smartfield.TextInEditModeSource.SmartFieldTextInEditModeSource/"
            });
            ...
            this.oModel = new ODataModel("smartfield.TextInEditModeSource.SmartFieldTextInEditModeSource");

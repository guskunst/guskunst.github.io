...
sap.ui.define([
	...
	QUnit.test("setEditMode", function(assert) {
		...
		assert.ok(oGroupElement1.setEditMode.called, "setEditMode called on GroupElement1");
		assert.ok(oGroupElement1.setEditMode.calledWith(true), "setEditMode called on GroupElement1 with \"true\"");
		assert.notOk(oGroupElement2.setEditMode.called, "setEditMode not called on GroupElement2 as not assigned to SmartForm");
		assert.notOk(oGroupElement3.setEditMode.called, "setEditMode not called on GroupElement3 as not assigned to SmartForm");
	});

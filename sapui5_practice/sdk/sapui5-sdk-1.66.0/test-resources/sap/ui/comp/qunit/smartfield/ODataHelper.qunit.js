...
sap.ui.define([
	...
	QUnit.test("getAbsolutePropertyPathToValueListEntity it should return the path to a OData entity data model property specified in the value list text annotation (test case 1)", function(assert) {
	...
	// BCP: 1980069522
	QUnit.test("getAbsolutePropertyPathToValueListEntity it should return the path to a OData entity data model property specified in the value list text annotation (test case 2)", function(assert) {
	...
	QUnit.test("getUOMChangeHandler", function(assert) {
		var bFire = false;
		var bExc = false;
		var bFired = false;
		var oControl = {
		...
		var oHandler = this.oMetaData.getUOMChangeHandler(oControl, true);
		oHandler({
			"mParameters": true
		});
		assert.ok(bFire);

sap.ui.define([
	...
	return UIComponent.extend("applicationUnderTestWithVariant.Component", {
		...
		init: function() {
			...
			// Save Variant
			FakeLrepLocalStorage.saveChange("id_applicationUnderTestWithVariant00_table", {
				changeType: "table",
				conditions: {},
				content: {
					sort: {
			...
			FakeLrepLocalStorage.saveChange("id_applicationUnderTestWithVariant01_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_applicationUnderTestWithVariant02_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_applicationUnderTestWithVariant03_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_applicationUnderTestWithVariant04_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_applicationUnderTestWithVariant05_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_applicationUnderTestWithVariant06_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_applicationUnderTestWithVariant07_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_applicationUnderTestWithVariant08_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_applicationUnderTestWithVariant09_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_applicationUnderTestWithVariant10_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_applicationUnderTestWithVariant11_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_applicationUnderTestWithVariant12_table", {
				changeType: "table",
				conditions: {},
				content: {
					group: {
			...
			FakeLrepLocalStorage.saveChange("id_applicationUnderTestWithVariant13_table", {
				changeType: "table",
				conditions: {},
				content: {
					group: {

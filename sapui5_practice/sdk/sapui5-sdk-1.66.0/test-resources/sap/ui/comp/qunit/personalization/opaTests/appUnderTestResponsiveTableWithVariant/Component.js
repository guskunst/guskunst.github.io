sap.ui.define([
	...
	return UIComponent.extend("appUnderTestResponsiveTableWithVariant.Component", {
		...
		init: function() {
			...
			// Save Sort Variant
			FakeLrepLocalStorage.saveChange("id_appUnderTestResponsiveTableWithVariant03_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_appUnderTestResponsiveTableWithVariant04_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_appUnderTestResponsiveTableWithVariant05_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_appUnderTestResponsiveTableWithVariant06_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_appUnderTestResponsiveTableWithVariant07_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_appUnderTestResponsiveTableWithVariant08_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_appUnderTestResponsiveTableWithVariant09_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_appUnderTestResponsiveTableWithVariant10_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {
			...
			FakeLrepLocalStorage.saveChange("id_appUnderTestResponsiveTableWithVariant11_table", {
				changeType: "table",
				conditions: {},
				content: {
					columns: {

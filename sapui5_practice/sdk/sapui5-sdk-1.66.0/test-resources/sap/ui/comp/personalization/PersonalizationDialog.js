sap.ui.require([
	...
	FakeLrepLocalStorage, CheckBox, PersonalizableInfo, PersController, UIState, Text, ChartWrapper, Table, Page, App, Toolbar, MultiComboBox, Button,
	...
	PersonalizationDialog.createVariants = function() {
		FakeLrepLocalStorage.saveChange("id_personalizationDialog00_table", {
			changeType: "table",
			conditions: {},
			content: {
				columns: {
		...
		FakeLrepLocalStorage.saveChange("id_personalizationDialog01_table", {
			changeType: "table",
			conditions: {},
			content: {
				sort: {
		...
		FakeLrepLocalStorage.saveChange("id_personalizationDialog02_table", {
			changeType: "table",
			conditions: {},
			content: {
				filter: {
		...
		FakeLrepLocalStorage.saveChange("id_personalizationDialog03_table", {
			changeType: "table",
			conditions: {},
			content: {
				group: {
		...
		FakeLrepLocalStorage.saveChange("id_personalizationDialog04_table", {
			changeType: "table",
			conditions: {},
			content: {
				columns: {

...
sap.ui.define([
	...
	QUnit.test("Checking single DateTime field", function(assert) {
		...
		bUTC = true;
		var oDate = oFilterBar.getDateInUTCOffset(new Date(oResult.BLDAT));

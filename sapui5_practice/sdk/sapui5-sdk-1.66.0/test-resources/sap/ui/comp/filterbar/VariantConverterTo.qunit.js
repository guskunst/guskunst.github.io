...
sap.ui.define([
	...
	QUnit.test("Checking the convertToSuiteFormat method: DateTime interval", function(assert) {
		...
		var oFilterBar = {
			...
			getDateInUTCOffset: function(oDate) {
				// return sap.ui.comp.smartfilterbar.FilterProvider.getDateInUTCOffset(oDate);
				return new Date(oDate.valueOf() - (-1 * 60) * 60 * 1000);
			}
		};
					...
					"Ranges": [
						{
							"Sign": "I",
							"Option": "BT",
							"Low": "2014-12-09T23:00:00.000",
							"High": "2014-12-09T23:00:00.000"
						}
					]
				}
			]
		...
		assert.ok(oExpectedNonUTCResult);
		...
		sResult = this.oVariantConverter.convert("id_1418632009069_83", oInternalFilters, JSON.stringify(oInternalOriginal), oFilterBar);
					...
					"Ranges": [
						{
							...
							"Sign": "I",
							"Option": "EQ",
							"Low": "2015-08-30T22:00:00.000",
							"High": null
						}, {
							"Sign": "I",
							"Option": "EQ",
							"Low": "2015-08-01T22:00:00.000",
							"High": null
						}
					]
				}
	...
	QUnit.test("Checking single date field", function(assert) {
		...
		var oFilterBar = {
			...
			getDateInUTCOffset: function(oDate) {
				return new Date(oDate.valueOf() - (-2 * 60) * 60 * 1000);
			}
		};
		...
		var oInternalOriginal = {
			"BLDAT": "2015-08-13T22:00:00.000Z"
		};
		...
		var oExpectedNonUTCResult = {
			...
			"Parameters": [
				{
					"PropertyName": "BLDAT",
					"PropertyValue": "2015-08-13T22:00:00.000"
				}
			]
		};
		...
		sResult = this.oVariantConverter.convert("", oInternalFilters, JSON.stringify(oInternalOriginal), oFilterBar);
		assert.equal(sResult, JSON.stringify(oExpectedUTCResult));
	});

...
sap.ui.define([
	"sap/ui/comp/smartfilterbar/SmartFilterBar", "sap/ui/comp/smartfilterbar/ControlConfiguration", "sap/ui/comp/smartfilterbar/GroupConfiguration", "sap/ui/comp/smartfilterbar/SelectOption", "sap/ui/comp/filterbar/FilterBar", "sap/ui/comp/filterbar/FilterGroupItem", "sap/m/Input", "sap/ui/core/ValueState", "sap/ui/model/json/JSONModel", "sap/ui/model/json/JSONPropertyBinding", "sap/m/DatePicker", "sap/m/SearchField", "sap/m/MessageBox", "sap/m/DateRangeSelection", "sap/m/MultiInput"
], function(SmartFilterBar, ControlConfiguration, GroupConfiguration, SelectOption, FilterBar, FilterGroupItem, Input, ValueState, JSONModel, JSONPropertyBinding, DatePicker, SearchField, MessageBox, DateRangeSelection, MultiInput) {
	"use strict";
	...
	QUnit.test("check _onMetadataInitialised", function(assert) {
		...
		fResolve(oFilterProvider);
		sinon.stub(this.oSmartFilter, "_initializeVariantManagement");
		sinon.stub(this.oSmartFilter, "_createFilterProvider").returns(oPromise);

		var done = assert.async();

		assert.ok(!this.oSmartFilter.bIsInitialised);

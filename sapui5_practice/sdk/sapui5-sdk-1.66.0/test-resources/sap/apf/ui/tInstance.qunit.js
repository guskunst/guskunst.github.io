(function() {
	...
	QUnit.test("Get Add Step Button", function(assert){
		var button = oUiApi.getAddAnalysisStepButton();
		assert.ok(button instanceof sap.m.Button, "Button returned");
		assert.strictEqual(button.getText(), oGlobalApi.oCoreApi.getTextNotHtmlEncoded("add-step"), "Button has correct Text");
	});
	...
	QUnit.module("Application Layout Creation", {
		beforeEach : function() {
			...
			this.stubGetCarousel = sinon.stub(this.instance, "getCarousel", getStub);
	...
	QUnit.test("check at getStepGallery", function(assert) {
		...
		this.stubGetStepGallery = sinon.stub(this.instance, "getStepGallery", function() {
			assert.ok(this.stubGetCarousel.notCalled, "getCarousel was not called");
	...
	QUnit.test("check at getCarousel", function(assert) {
		var done = assert.async();
		this.stubGetCarousel.restore();
		this.stubGetCarousel = sinon.stub(this.instance, "getCarousel", function() {
	...
	QUnit.test("check at getAnalysisPath", function(assert) {
		...
		this.stubGetAnalysisPath = sinon.stub(this.instance, "getAnalysisPath", function() {
			...
			assert.ok(this.stubGetCarousel.calledOnce, "getCarousel was called once");

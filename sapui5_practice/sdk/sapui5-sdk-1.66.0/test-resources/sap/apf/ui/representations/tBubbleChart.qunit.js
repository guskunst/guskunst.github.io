...
sap.ui.define("sap/apf/ui/representations/tBubbleChart.qunit", [
	...
	function _commonInitializationAsserts(chart, assert) {
		...
		assert.strictEqual(chart.thumbnailChart.getVizType(), "bubble", "Then thumbnailcontent has Bubble chart");
	}
	...
	QUnit.test("When Bubble Chart is initialized with multiple parameters", function(assert) {
		...
		assert.strictEqual(this.chart.thumbnailChart.getVizType(), "bubble", "Then thumbnailcontent has Bubble chart");

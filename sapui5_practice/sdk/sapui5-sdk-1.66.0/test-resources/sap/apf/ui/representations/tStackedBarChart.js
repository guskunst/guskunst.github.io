...
sap.ui.define("sap/apf/ui/representations/tStackedBarChart", [
	...
	function _commonInitializationAsserts(chart, assert) {
		...
		assert.strictEqual(chart.thumbnailChart.getVizType(), "stacked_bar", "Then thumbnailcontent has Stacked Bar chart");
	}
	...
	QUnit.test("When Stacked Bar Chart is initialized with multiple parameters", function(assert) {
		...
		assert.strictEqual(this.chart.thumbnailChart.getVizType(), "stacked_bar", "Then thumbnailcontent has Stacked Bar chart");

...
sap.ui.define("sap/apf/ui/representations/tLineChart", [
	...
	function _commonInitializationAsserts(chart, assert) {
		...
		assert.strictEqual(chart.thumbnailChart.getVizType(), "line", "Then thumbnailcontent has Line chart");
	}
	...
	QUnit.test("When Line Chart is initialized with multiple parameters", function(assert) {
		...
		assert.strictEqual(this.chart.thumbnailChart.getVizType(), "line", "Then thumbnailcontent has Line chart");

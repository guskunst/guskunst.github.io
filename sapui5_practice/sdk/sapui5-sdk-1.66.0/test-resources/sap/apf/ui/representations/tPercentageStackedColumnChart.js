...
sap.ui.define("sap/apf/ui/representations/tPercentageStackedColumnChart", [
	...
	function _commonInitializationAsserts(chart, assert) {
		...
		assert.strictEqual(chart.thumbnailChart.getVizType(), "100_stacked_column", "Then thumbnailcontent has Percentage Stacked Column chart");
	}
	...
	QUnit.test("When Percentage Stacked Column Chart is initialized with multiple parameters", function(assert) {
		...
		assert.strictEqual(this.chart.thumbnailChart.getVizType(), "100_stacked_column", "Then thumbnailcontent has Percentage Stacked Column chart");

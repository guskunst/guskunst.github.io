...
sap.ui.define("sap/apf/ui/representations/tBarChart", [
	...
	function _commonInitializationAsserts(chart, assert) {
		...
		assert.strictEqual(chart.thumbnailChart.getVizType(), "bar", "Then thumbnailcontent has Bar chart");
	}
	...
	QUnit.test("When Bar Chart is initialized", function(assert) {
		...
		var vizPropOnThumbnailChart = RepresentationHelper.prototype.getVizPropertiesJSONOnThumbnail();
	...
	QUnit.test("When Bar Chart is initialized with multiple parameters", function(assert) {
		...
		assert.strictEqual(this.chart.thumbnailChart.getVizType(), "bar", "Then thumbnailcontent has Bar chart");

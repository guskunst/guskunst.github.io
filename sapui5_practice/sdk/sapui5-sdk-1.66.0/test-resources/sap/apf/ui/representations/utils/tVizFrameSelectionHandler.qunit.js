	...
	QUnit.module("VizFrame Selection Handler with default label of property", {
		beforeEach : function(assert) {
			...
			sap.apf.testhelper.doubles.createUiApiAsPromise().done(function(oApi) {
				...
				oVizFrameSelectionHandler = new sap.apf.ui.representations.utils.VizFrameSelectionHandler(oParameter, that.oGlobalApi.oApi);
				done();
			});
		},
		afterEach: function(){
	...
	QUnit.module("VizFrame Selection Handler getSelectionInfoFromEvent without initial selection", {
		beforeEach : function(assert) {
			...
			sap.apf.testhelper.doubles.createUiApiAsPromise().done(function(oApi) {
				...
				testEnv.oSelectionHandler = new sap.apf.ui.representations.utils.VizFrameSelectionHandler(parameter, oApi);
				done();
			})
		},
		afterEach: function(){

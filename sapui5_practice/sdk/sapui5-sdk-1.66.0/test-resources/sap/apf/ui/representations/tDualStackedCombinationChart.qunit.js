...
sap.ui.define("sap/apf/ui/representations/tDualStackedCombinationChart.qunit", [
	...
	QUnit.test("Specific vizProperties for Thumbnail chart", function(assert) {
		var vizProperties;
		this.dualStackedCombinationChart.thumbnailChart = {
			setVizProperties : function(properties){
				vizProperties = properties;
			}
		};
		...
		this.dualStackedCombinationChart.setVizPropsOfThumbnailForSpecificRepresentation();
		assert.deepEqual(vizProperties, expectedVizProperties, "Specific vizproperties for thumbnail chart is set");
	});
});

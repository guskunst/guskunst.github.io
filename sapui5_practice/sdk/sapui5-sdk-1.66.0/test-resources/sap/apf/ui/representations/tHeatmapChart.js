...
sap.ui.define("sap/apf/ui/representations/tHeatmapChart", [
	...
	function _commonInitializationAsserts(chart, assert) {
		...
		assert.strictEqual(chart.thumbnailChart.getVizType(), "heatmap", "Then thumbnailcontent has Heatmap chart");
	}
	...
	QUnit.test("When Heatmap Chart is initialized with multiple parameters", function(assert) {
		...
		assert.strictEqual(this.chart.thumbnailChart.getVizType(), "heatmap", "Then thumbnailcontent has Heatmap chart");

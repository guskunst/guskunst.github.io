...
sap.ui.define("sap/apf/ui/representations/tLineChartWithTimeAxis", [
	...
	function _commonInitializationAsserts(chart, assert) {
		...
		assert.strictEqual(chart.thumbnailChart.getVizType(), "timeseries_line", "Then thumbnailcontent has Time axis line chart");
	...
	QUnit.test("When Line Chart With Time Axis is initialized with multiple parameters", function(assert) {
		...
		assert.strictEqual(this.chart.thumbnailChart.getVizType(), "timeseries_line", "Then thumbnailcontent has Time axis line chart");

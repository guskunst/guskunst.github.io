...
sap.ui.define("sap/apf/ui/representations/tBaseVizFrameChartRepresentation.qunit", [
	...
	/*BEGIN_TEMPORARY_FIX*/
	var VizFrameSelectionHandler = sap.apf.ui.representations.utils;
	/*END_TEMPORARY_FIX*/
	...
	QUnit.module("Base VizFrame Chart Representation manageSelectionsOnChart with changed filter values", {
		beforeEach : function(assert) {
			...
			createUiApiAsPromise().done(function(oApi) {
				...
				testEnv.newVizFrameSelectionHandlerStub = sinon.stub(VizFrameSelectionHandler, "VizFrameSelectionHandler", function() {
	...
	QUnit.module("setVizPropertiesOnChart for specific chart types", {
		beforeEach : function() {
			...
			this.stubSetVizPropertiesForCombinationCharts = sinon.stub(this.baseVizFrameChartRepresentation, "setVizPropertiesForCombinationCharts", function(){
	...
	QUnit.test("With measures, but without measureOptions", function(assert) {
		...
		assert.deepEqual(this.baseVizFrameChartRepresentation.setVizPropertiesForCombinationCharts(this.representationTypesHandler), expectedVizProperties, "DataShape property correctly returned");
	});

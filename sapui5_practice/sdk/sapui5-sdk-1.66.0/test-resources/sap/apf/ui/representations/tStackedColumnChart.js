...
sap.ui.define("sap/apf/ui/representations/tStackedColumnChart", [
	...
	function _commonInitializationAsserts(chart, assert) {
		...
		assert.strictEqual(chart.thumbnailChart.getVizType(), "stacked_column", "Then thumbnailcontent has Stacked Column chart");
	}
	...
	QUnit.test("When Stacked Column Chart is initialized with multiple parameters", function(assert) {
		...
		assert.strictEqual(this.chart.thumbnailChart.getVizType(), "stacked_column", "Then thumbnailcontent has Stacked Column chart");

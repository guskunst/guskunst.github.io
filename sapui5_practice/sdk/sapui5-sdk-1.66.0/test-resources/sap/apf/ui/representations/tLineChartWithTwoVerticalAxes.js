...
sap.ui.define("sap/apf/ui/representations/tLineChartWithTwoVerticalAxes", [
	...
	function _commonInitializationAsserts(chart, assert) {
		...
		assert.strictEqual(chart.thumbnailChart.getVizType(), "dual_line", "Then thumbnailcontent has Dual Line chart");
	}
	...
	QUnit.test("When Dual Line Chart is initialized with multiple parameters", function(assert) {
		...
		assert.strictEqual(this.chart.thumbnailChart.getVizType(), "dual_line", "Then thumbnailcontent has dual line chart");

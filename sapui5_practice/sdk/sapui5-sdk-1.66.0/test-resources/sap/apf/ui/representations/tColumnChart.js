...
sap.ui.define("sap/apf/ui/representations/tColumnChart", [
	...
	function _commonInitializationAsserts(chart, assert) {
		...
		assert.strictEqual(chart.thumbnailChart.getVizType(), "column", "Then thumbnailcontent has Column chart");
	}
	...
	QUnit.test("When Column Chart is initialized with multiple parameters", function(assert) {
		...
		assert.strictEqual(this.chart.thumbnailChart.getVizType(), "column", "Then thumbnailcontent has Column chart");

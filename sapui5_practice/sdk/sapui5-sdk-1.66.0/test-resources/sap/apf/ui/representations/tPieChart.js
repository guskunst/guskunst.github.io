...
sap.ui.define("sap/apf/ui/representations/tPieChart", [
	...
	function _commonInitializationAsserts(chart, assert) {
		...
		assert.strictEqual(chart.thumbnailChart.getVizType(), "pie", "Then thumbnailcontent has Pie chart");
	}
	...
	QUnit.test("When Pie Chart is initialized with multiple parameters", function(assert) {
		...
		assert.strictEqual(this.chart.thumbnailChart.getVizType(), "pie", "Then thumbnailcontent has Pie chart");

...
(function() {
	...
	var getAnalysisPathStub = function() {
		var Control = sap.ui.core.Control.extend("test.sap.apf.analysisPathStub", {});
		var analysisPath = new Control();
		analysisPath.getCarousel = function() {
			var carousel = {};
	...
	QUnit.test("Click chartSwitch when only more charts are available", function(assert) {

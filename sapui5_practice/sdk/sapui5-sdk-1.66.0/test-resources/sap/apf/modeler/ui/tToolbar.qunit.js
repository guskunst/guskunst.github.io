...
sap.ui.define("sap.apf.modeler.ui.tToolbar.qunit",[
	...
	QUnit.test("Test handleAddMenuItemPress", function(assert) {
		...
		this.toolbarController._handleAddMenuItemPress(oEvtStub);
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[0].getNodes()[1].getNodes()[0].getNodes().length, 4, "New step node was added on press of add hierarchical step option in add menu ");
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[0].getNodes()[1].getNodes()[0].getNodes()[2].getText(), "< " + this.oModelerInstance.modelerCore.getText("newStep") + " >", "The new node has the text <New Step>");
		this.oConfigListInstance.oTreeInstance.setSelectionOnTree("/aConfigDetails/0/configData/1/categories/0/steps/0");
		oEvtStub = {
			getParameters : function() {
		...
		this.toolbarController._handleAddMenuItemPress(oEvtStub);
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[0].getNodes()[1].getNodes()[0].getNodes()[0].getNodes().length, 4, "New representation node was added on press of add representation option in add menu ");
		assert.equal(this.oConfigListInstance.oTreeInstance.getNodes()[0].getNodes()[1].getNodes()[0].getNodes()[0].getNodes()[3].getText(), "Column Chart", "The new node has the text Column Chart");
		oEvtStub = {
			getParameters : function() {
				var obj = {};

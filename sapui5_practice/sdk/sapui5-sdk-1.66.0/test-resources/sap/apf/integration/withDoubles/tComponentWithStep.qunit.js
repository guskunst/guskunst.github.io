...
sap.ui.define([
	...
	/** sub a UI5 utility function which currently causes a master build error */
	function stubUI5function(that){
		if (sap.ui && sap.ui.fl && sap.ui.fl.Utils){
			that.spy.isTrialSystem = sinon.stub(sap.ui.fl.Utils, "isTrialSystem", function(){
				return false;
			});
		}
	}

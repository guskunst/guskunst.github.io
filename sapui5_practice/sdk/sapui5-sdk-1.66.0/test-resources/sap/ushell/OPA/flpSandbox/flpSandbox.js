...
sap.ui.define([
...
], function (oConstants, fnBootTask, fnConfigureUShell, fnLoadLaunchpad, oUtil, Config, fnCreateCoreConfigContract, JSONModel) {
    "use strict";
    ...
    function _applyConfiguration(oConfiguration) {
        Config._reset();
        Config.registerConfiguration(null, fnCreateCoreConfigContract(oConfiguration));
    }

    ...
    Opa5.createPageObjects({
        onShellHeader: {
            actions: {
                ...
                //TODO Currently simulate the resizing by calling the handler with parameters
                //need to find better way for resizing
            ...
            assertions: {
                ...
                iSholdSeeOpenSearch: function (bOpen) {
                    return this.waitFor({
                        id: "searchFieldInShell",
                        success: function (oSearchField) {
                            var sNot = bOpen ? "": " not";
                            Opa5.assert.ok(oSearchField.$().width() > 0 === bOpen, "Search field is" + sNot + " visible");
                        },
                ...
                iSholdNotSeeSearchOverlay: function () {
                    return this.waitFor({
                        ...
                        success: function (oShellHeader) {
                            Opa5.assert.ok(!oShellHeader.hasStyleClass("sapUshellShellShowSearchOverlay"), "Search overlay is not set on the header");
                        },
                        errorMessage: "Search field is not in the header"
                    });
                },

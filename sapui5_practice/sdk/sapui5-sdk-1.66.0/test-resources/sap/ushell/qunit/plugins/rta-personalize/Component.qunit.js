...
function (
	...
	QUnit.module("init functionality", {
		...
		QUnit.test("When personalizable controls get rendered and removed with control in event", function (assert) {
			...
			sap.ui.getCore().getEventBus().publish("sap.ui", "ControlForPersonalizationRendered", oFakeObjectPageLayout0);
			...
			sap.ui.getCore().getEventBus().publish("sap.ui", "ControlForPersonalizationRendered", oFakeObjectPageLayout1);
		...
		QUnit.test("When personalizable controls get rendered and removed with control ID in event", function (assert) {
			...
			sap.ui.getCore().getEventBus().publish("sap.ui", "ControlForPersonalizationRendered", oFakeObjectPageLayout0.getId());
			...
			sap.ui.getCore().getEventBus().publish("sap.ui", "ControlForPersonalizationRendered", oFakeObjectPageLayout1.getId());
			assert.equal(this.oPlugin._aPersonalizableControls.length, 2, "then two control are in the array");

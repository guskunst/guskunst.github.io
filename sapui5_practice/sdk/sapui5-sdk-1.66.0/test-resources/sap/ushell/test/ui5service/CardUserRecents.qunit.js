...
sap.ui.require([
    ...
    "sap/ushell/EventHub",
    "sap/ushell/Config"
], function (jQuery, CardUserRecents, CardUserRecentsBase, EventHub, Config) {
    "use strict";
    ...
    QUnit.test("Calls the parent class constructor", function (assert) {
        ...
        assert.ok(this.constructorCallStub.calledWithExactly(this.oCardUserRecents, "CardUserRecents"), "The constructor called the parent constructor with the right parameters.");
    });

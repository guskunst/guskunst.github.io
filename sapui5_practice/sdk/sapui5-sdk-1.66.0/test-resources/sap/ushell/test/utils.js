...
sap.ui.define([
    ...
    "use strict";
    /* global ok, deepEqual, strictEqual, start, URI */
    ...
    function createLogMock () {
        ...
        function replay (sMethodName, aArguments) {
            ...
            if (!oExpectedCall) {
                ok(false, "Unexpected call to method " + sMethodName + " with arguments " + Array.prototype.join.call(aArguments));
                return;
            }
    ...
    function resetConfigChannel (oUshellConfig) {
        ...
        var fnCreateCoreConfigContract = sap.ui.require("sap/ushell/bootstrap/common/common.create.configcontract.core");
        var Config = sap.ui.require("sap/ushell/Config");

        var oContract = fnCreateCoreConfigContract(oUshellConfig);

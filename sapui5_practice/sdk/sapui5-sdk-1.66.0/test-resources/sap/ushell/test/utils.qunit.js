...
sap.ui.require([
    ...
    "sap/ushell/library"  // to expose sap.ushell.components.container.ApplicationType
    ...
    var O_KNOWN_APPLICATION_TYPES = sap.ushell.components.container.ApplicationType;
    ...
    test("utils.isDefined returns as expected", function () {
        var testObject = {
            ...
            isDefinedFalse = utils.isDefined(testObject["definedAndFalse"]),
    ...
    test(["utils.isNativeWebGuiNavigation returns true if TR in resolved",
    ...
    [ {
      ...
      },
      {
        ...
        test("utils.isNativeWebGuiNavigation url detection: applicationType : '" + oFixture.applicationType + "', url:'" + oFixture.url + "'", function () {
            var bResult;
            sinon.stub(utils, "hasNativeNavigationCapability").returns(true);
            bResult = utils.isNativeWebGuiNavigation({
            ...
            utils.hasNativeNavigationCapability.restore();
        });
    });
    ...
    [
        ...
        test("utils.appendUserIdToUrl: adds sap-user correctly to " + oFixture.sUrl, function () {
            ...
            if (typeof sap.ushell.Container !== "undefined") {
                ...
                strictEqual(utils.appendUserIdToUrl(sParamName, oFixture.sUrl),
    ...
    [
        ...
        test("utils.isClientSideNavTargetResolutionEnabled: returns expected result when jQuery.sap.storage is available and " + oFixture.testDescription, function () {
            ...
            strictEqual(utils.isClientSideNavTargetResolutionEnabled(),
    ...
    [
     ...
     },
     {
         ...
         test("getMember when " + oFixture.description, function () {
             var bResult = utils.getMember(oFixture.oAppDesc,oFixture.sPath);
...
//        }
    ...
    test("invokeUnfoldingArrayArguments simple invoke", function () {
        ...
        var prx = utils.invokeUnfoldingArrayArguments(fnx,["a","b","c"]).done(function (res) {
...
TODO: Change test once dynamic tile logic change will be complete
    ...
    */
    ...
    test("shallowMergeObject: merges as expected when multiple objects are given", function () {
        ...
        var oSource1 = { key3: "V3" };
        var oSource2 = { key4: "V4" };
        var oSource3 = { key5: "V5" };
    ...
    test("shallowMergeObject: multiple objects are merged in order", function () {
        ...
        var oSource1 = { key: "First" };
        var oSource2 = { key: "Second" };
        var oSource3 = { key: "Last" };
    ...
    [
        ...
        { testDescription: "object containing a Promise", vData: { "object": Promise.resolve(1) } },
        {
    ...
    test("utils.removeDuplicatedActions: in case all array items are the same returns an array with one item", function() {
        ...
        var aExpectedUniqueActions = ["item1"];
    ...
    test("utils.removeDuplicatedActions: in case of duplicates array with unique items is returned", function() {
        ...
        var aExpectedUniqueActions = ["item1", "item2", "item3"];

...
/**
 * @fileOverview QUnit tests for sap.ushell.components.shell.Notifications.fiori3.Notifications
 */
sap.ui.require([
    ...
    "use strict";
    /*global QUnit jQuery sap sinon window hasher */
    ...
    QUnit.module("sap.ushell.components.shell.Notifications.fiori3.Notifications", {
        beforeEach: function (assert) {
            ...
            sap.ushell.bootstrap("local").then(function () {
                ...
                this.getNotificationsBufferInGroup = sinon.stub(this.oService, "getNotificationsBufferInGroup").returns(jQuery.Deferred().resolve(
                    [{"Id":"005056b4-24bc-1ee7-85aa-1d95eca8fde2","OriginId":"LOCAL","CreatedAt":"2017-03-30T13:58:17Z","IsActionable":true,"IsRead":false,"IsGroupable":true,"IsGroupHeader":false,"NavigationTargetAction":"toappstatesample","NavigationTargetObject":"Action","NavigationIntent":"Action-toappstatesample","NotificationTypeId":"005056b4-24bc-1ee7-85aa-1d95eca93de2","NotificationTypeKey":"PurchaseOrderType2Key","ParentId":"005056b4-24bc-1ee7-85aa-1d95eca93de2","Priority":"HIGH","SensitiveText":"Purchase order #1440 for $2,000 by Gavin Gradel requires your approval","Text":"A purchase order requires your approval","GroupHeaderText":"","NotificationCount":0,"SubTitle":"Over the last 12 months Gavin Gradel ordered goods $2,000.Currently 10.000 are due.","NotificationTypeDesc":"Purchase Order","Actor":{"Id":"MOSSERI","DisplayText":"MOSSERI","ImageSource":"https://scn.sap.com/people/guest/avatar/MOSSERI.png"},"NavigationTargetParams":[{"NotificationId":"005056b4-24bc-1ee7-85aa-1d95eca8fde2","Key":"PurchaseOrderId","Value":"236400"},{"NotificationId":"005056b4-24bc-1ee7-85aa-1d95eca8fde2","Key":"PurchaseOrderVendor","Value":"PARTNER_137"}],"Actions":[{"ActionId":"AcceptPOActionKey","ActionText":"Accept","GroupActionText":"Accept All","Nature":"POSITIVE"},{"ActionId":"RejectPOActionKey","ActionText":"Reject","GroupActionText":"Reject All","Nature":"NEGATIVE"}]},{"Id":"005056b4-24bc-1ee7-85aa-1d95eca91de2","OriginId":"LOCAL","CreatedAt":"2017-03-30T13:58:17Z","IsActionable":true,"IsRead":false,"IsGroupable":true,"IsGroupHeader":false,"NavigationTargetAction":"toappstatesample","NavigationTargetObject":"Action","NavigationIntent":"Action-toappstatesample","NotificationTypeId":"005056b4-24bc-1ee7-85aa-1d95eca93de2","NotificationTypeKey":"PurchaseOrderType2Key","ParentId":"005056b4-24bc-1ee7-85aa-1d95eca93de2","Priority":"HIGH","SensitiveText":"Purchase order #3631 for $1,000 by Gavin Gradel requires your approval","Text":"A purchase order requires your approval","GroupHeaderText":"","NotificationCount":0,"SubTitle":"Over the last 12 months Gavin Gradel ordered goods $1,000.Currently 10.000 are due.","NotificationTypeDesc":"Purchase Order","Actor":{"Id":"MOSSERI","DisplayText":"MOSSERI","ImageSource":"https://scn.sap.com/people/guest/avatar/MOSSERI.png"},"NavigationTargetParams":[{"NotificationId":"005056b4-24bc-1ee7-85aa-1d95eca91de2","Key":"PurchaseOrderId","Value":"236400"},{"NotificationId":"005056b4-24bc-1ee7-85aa-1d95eca91de2","Key":"PurchaseOrderVendor","Value":"PARTNER_137"}],"Actions":[{"ActionId":"AcceptPOActionKey","ActionText":"Accept","GroupActionText":"Accept All","Nature":"POSITIVE"},{"ActionId":"RejectPOActionKey","ActionText":"Reject","GroupActionText":"Reject All","Nature":"NEGATIVE"}]}]
                ));
        ...
        afterEach: function () {
          ...
          //  thiub.restore();
            ...
            this.oView.destroy();
            var aNotificationListIds = ["sapUshellNotificationsListType", "sapUshellNotificationsListPriority", "sapUshellNotificationsListDate"];
    ...
    QUnit.test("test actionButtonPressHandler DeleteOnReturn", function (assert) {
        var oExecuteActionResponse_DeleteOnReturnTrue = {
                isSucessfull : true,
                message : "Leave Request approved successfully",
                DeleteOnReturn : true
            },
            oExecuteActionResponse_DeleteOnReturnFalse = {
                isSucessfull : true,
                message : "Leave Request approved successfully",
                DeleteOnReturn : false
            },
            oExecuteActionResponse_NoDeleteOnReturn = {
                isSucessfull : true,
                message : "Leave Request approved successfully"
            },
            oDeferred,
        ...
        oDeferred.resolve(oExecuteActionResponse_DeleteOnReturnTrue);
        oExecuteActionStub = sinon.stub(this.oController, "executeAction").returns(oDeferred.promise());
        this.oController.onNotificationItemButtonPress(oEvent);
        ...
        oDeferred = new jQuery.Deferred();
        oDeferred.resolve(oExecuteActionResponse_DeleteOnReturnFalse);
        oExecuteActionStub = sinon.stub(this.oController, "executeAction").returns(oDeferred.promise());
        this.oController.onNotificationItemButtonPress(oEvent);
        ...
        oDeferred = new jQuery.Deferred();
        oDeferred.resolve(oExecuteActionResponse_NoDeleteOnReturn);
        oExecuteActionStub = sinon.stub(this.oController, "executeAction").returns(oDeferred.promise());
        this.oController.onNotificationItemButtonPress(oEvent);
    ...
    QUnit.test("test getNextBuffer", function (assert) {
       ...
       // assert.ok(this.oController.handleBusyIndicatorToTabFilter.calledOnce === true, "handleBusyIndicatorToTabFilter is called when there are no item in model, handleBusyIndicatorToTabFilter called");
        //assert.ok(this.oController.handleBusyIndicatorToTabFilter.args[0][0] === true, "handleBusyIndicatorToTabFilter, First call with value = true");
    ...
    QUnit.test("verify executeBulkAction reject", function (assert) {
        ...
        dfd.reject({
            "succededNotifications": [
                "005056b4-24bc-1ee7-85aa-1d95eca91de2"
            ],
            "failedNotifications": [
                "005056b4-24bc-1ee7-85aa-1d95eca8fde2"
            ]
        });
        assert.ok(this.executeBulkActionStub.calledOnce, 'executeBulkAction service call was done');
        aGroups = this.oController.getView().getModel().getProperty("/notificationsByTypeDescending");
    ...
    QUnit.test("verify dismissBulkNotifications reject", function (assert) {
        var oGroupToDelete = {Id: "005056ab-6fd8-1ee5-b3ca-91c4c583b209", aNotifications: [{Id: "005056ab-6fd8-1ee5-bb88-b1231d763dd0"}, {Id: "005056ab-6fd8-1ee5-bb88-b15ceb897dd0"}]},
            aGroups,
            dfd = jQuery.Deferred();
    ...
    QUnit.test("filterDismisssedItems: dismissed items are filtered out when dismissed items exist", function (assert) {
        var aFitered = this.oService.filterDismisssedItems(
            [{originalItemId:"01"}, {originalItemId:"02"} ], ["01"]
        );

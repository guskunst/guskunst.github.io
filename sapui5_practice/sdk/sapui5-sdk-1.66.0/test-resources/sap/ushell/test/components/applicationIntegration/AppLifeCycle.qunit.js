...
sap.ui.require([
...
], function (AppLifeCycle, utils, Container, Config, ApplicationContainerDummy, HeaderManager) {
    "use strict";
                        ...
                        "hashChange": {
                            ...
                            fnResponseHandler: function (oPromoise) {
                                oPromoise.then(function (oRespData) {
                                    assert.strictEqual(oRespData.length, 3, "Validate broadcast to 3 applications: 2 applications in storage + 1 application in focus");
                                    ...
                                    assert.strictEqual(oRespData[2].serviceName, "post1testid2", "Validate scound callback");
    ...
    QUnit.test("Test Integration with Storage", function (assert) {
        ...
        [
            ...
            AppLifeCycle.storeApp("testid4", { name: "oContainerTest",
                getUi5ComponentName: function () {
                    return "cmp1test1";
                }}, "testid4");
            AppLifeCycle.onComponentCreated({}, {}, {
            ...
            AppLifeCycle.storeApp("testid5", { name: "oContainerTest",
                getUi5ComponentName: function () {
                    return "cmp1test1";
                }}, "testid5");
            AppLifeCycle.onComponentCreated({}, {}, {

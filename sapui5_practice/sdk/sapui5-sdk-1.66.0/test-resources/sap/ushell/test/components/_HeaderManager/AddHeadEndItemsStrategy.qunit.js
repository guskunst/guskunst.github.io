 ...
 */
sap.ui.require([
    "sap/ushell/components/_HeaderManager/AddHeadEndItemsStrategyFiori3"
    ...
    [
        ...
        },
        {
            ...
            aIdsToAdd: ["id1"],
            expectedOutput: ["sf", "copilotBtn", "NotificationsCountButton", "id1"]
        }
    ...
    [
        ...
        },
        {
            ...
            expectedOutput: ["id1", "NotificationsCountButton", "id2"]
        },
        {

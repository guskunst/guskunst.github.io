    ...
    [
        ...
        module("sap.ushell.services.LaunchPage " + oFixture.testDescription, {
            ...
            beforeEach: function (assert) {
                oLastStub = sinon.stub(Config, "last", function () {
                    return oFixture.input.enableFeaturedGroup;
                });
        ...
        test("getCatalogTileView", function () {
            ...
            oJQuaryRequireStub = sinon.stub(jQuery.sap, "require", function (sResourcePath) {

            }),
            oJQuaryGetObjectStub = sinon.stub(jQuery.sap, "getObject", function (sObjectPath) {
        ...
        asyncTest("getCatalogTileViewControl", function () {
            var oLaunchPageAdapter = new LaunchPageAdapter(undefined, undefined, oLaunchPageConfig),
                ...
                oRequireStub = sinon.stub(sap.ui, "require", function (aRequirePath, fCallback) {

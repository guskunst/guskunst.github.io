...
sap.ui.require([
    ...
    /*global Promise asyncTest, deepEqual, equal, strictEqual, module, ok, parseInt, start,
     stop, sinon, jQuery, QUnit, sap, window */
        ...
        },
        {
            ...
            "oPlugins": {
                "appWarmup": {
                    ...
                    "url": "/sap/test/url/to/Component",
                    "config": {
                        "sap-ushell-plugin-type": "AppWarmup"
                    }
                },
                "testPlugin2": {
                    "component": "sap.test.TestComponent2",
                ...
                .done(function () {
                    ...
                    oDeferredPlugin.promise()
                        .always(function () {
                            start();
                            // assert
                            strictEqual(oSrvcUi5ComponentLoaderStub.callCount,
                                oFixture.expected.expectedCreateComponentCalls,
                                "createComponent of Ui5ComponentLoader was called once and resolved.");
                            strictEqual(oSrvcPluginManager._handleXhrAuthentication.callCount,
                                1,
        ...
        },
        {
            ...
            expected: {
                ...
                logError: [
                    ...
                    + " with URL '/sap/test/url/to/Component': 'NOT_AN_INTEGER' is not a number."

...
sap.ui.require([
    ...
    module("sap.ushell.services.ReferenceResolver", {
        setup: function () {
            ...
            // Ensure test doesn't rely on other services or the
            // container object (i.e., test is isolated)
    ...
    (function () {
        ...
        var oBaseEnv = {
            /*
             * This is the base environment containing the raw values usually
             * stored deeply in the User object or the UI5 configuration, which
             * will be mocked accordingly in the tests.
             */
    ...
    [
        ...
        },
        {
           ...
           oDefaultResolvedReferences: {
               "User.env.sap-theme": { value: "our_theme" }
           },
           expectedResolution: {
               "User.env.sap-theme": "our_theme"
           }
        },
        {
    ...
    [
        ...
        },
        {
            ...
            input: {
                sUrl: "/some/url?a=b&c={Edm.String%%noUserDefault.foo%%}&d={Edm.String%%UserDefault1%%}&e={Edm.String%%UserDefault.%%}"
            },
            expected: {
                result: {
        ...
        },
        {
            ...
            input: {
                ...
                oResolvedReferences: {
                    "UserDefault.CompanyCode": "hello world?"
                }
            },
            expected: {
                result: {
        ...
        },
        {
            ...
            input: {
                sUrl: "/some/url?a=b&c={Edm.String%%User.env.sap-theme-name%%}&d=100"
            },
            expected: {
                result: {
        ...
        },
        {
            ...
            input: {
                ...
                oResolvedReferences: {
                    "UserDefault.choosenPath" : "oData.svc"
                }
            },
            expected: {
                result: {
        ...
        asyncTest("resolveUserDefaultParameters " + oFixture.testDescription, function () {
            ...
            //Arrange
            var fnResolveRefsStub = sinon.stub(this.oService, "resolveReferences", function (aReferences) {

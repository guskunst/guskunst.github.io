...
sap.ui.require([
    ...
    'sap/ushell/EventHub'
], function (AppConfiguration, testUtils, EventHub) {
    "use strict";
    /* global module test ok sinon equals hasher stop start */
    ...
    */
    ...
    test("Test getSettingsControl", function (assert) {
        var oAppConfigurationSrvc = AppConfiguration,
            ...
            oGetObjectStub = sinon.stub(jQuery.sap, "getObject").returns(oReturnedConstructor);
            ...
            ok(oGetObjectStub.calledOnce === true, "jQuery.sap.getObject called once");

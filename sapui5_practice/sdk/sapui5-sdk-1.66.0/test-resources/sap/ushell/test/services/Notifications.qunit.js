...
sap.ui.require([
    ...
    QUnit.test("Read UserSettings flags from personalization service - empty result", function (assert) {
        ...
        testAsync(assert, function (oService) {
            ...
            oFlagsPromise.done(function (oFlags) {
                assert.ok(oFlags.previewNotificationEnabled === false, "previewNotificationEnabled flag has the default value (true) after Personalizer returnd empty object");
    ...
    QUnit.test("Read UserSettings flags from personalization service", function (assert) {
        ...
        testAsync(assert, function (oService) {
            ...
            oFlagsPromise.done(function (oFlags) {
                assert.ok(oFlags.previewNotificationEnabled === false, "previewNotificationEnabled flag has the correct value (false) returned from Personalization service");

sap.ui.require([
...
], function (utils, testUtils, PersonalizationProcessor, navigationMode) {
    "use strict";

    /* jslint nomen: true, sub: true */
    /* eslint-disable no-console */
    /* global asyncTest assert jQuery QUnit ok module parseInt sap sinon start stop window */
     ...
     *
     * @param {object} oSite
     *  The site Object to be returned by the getSite method
     */
    function stubUsedServices (oSite) {
        ...
        sinon.stub(sap.ushell.Container, "getService", function (sServiceName) {
            ...
            // Silence ClientSideTargetResolution because we are not interested
            // in comparing the results of #resolveTileIntent (we trust it's
            // well unit tested).
     ...
     *
     * @param {object} oGroup
     *   The group to get the tiles from
     * @param {object} oLPAInstance
     *   The LaunchPageAdapter instance
     * @returns {array}
     *   An array of tiles without links
     */
    ...
    /**
     * Finds the index of a site item with an identification section (e.g.,
     * catalog, group) in a given collection.
     *
     * @param {array} aCollection
     *   A collection of objects, each with an identification.id member or an
     *   id member at top-level.
     * @param {string} sSearchId
     *   The id of the item to search in the collection.
     * @returns {number}
     *   The index of the item in the collection array searched by id. The .id
     *   field at top-level is checked if an identification section is not
     *   available in the collection item.
     */
     ...
     *
     * @param {string} iMaybeNegativeIndex
     *   A possibly negative index
     * @param {array} aCollection
     *   A collection of items.
     * @returns {number}
     *   The positive index that can be used to pick out the item from the array.
     */
    ...
    var oExecuteActionFunctions = {
        ...
        /**
         * Moves a group within the site object before or after a given
         * existing group.
         *
         * @param {object} oArgs
         *   An object like:
         ...
         *   A promise that resolves when the operation is completed or rejects
         *   with undefined otherwise.
         */
         ...
         * </pre>
         *
         * Note: negative indices are also ok. They denote indices starting
        ...
        changeTileProperties: function (oArgs) {
            ...
            this.oLPA.getGroups()
                .done(function (aGroups) {
                    ...
                    // must add the tileComponent field before proceeding
                    // because the test doesn't set it...
    ...
    module("sap.ushell.services.CommonDataModel.PersonalizationProcessor", {
        setup: function () {
            ...
            this.oLPA = new sap.ushell.adapters.cdm.v3.LaunchPageAdapter(
                undefined, undefined, {
                    config: {}
                });
    ...
    var oFixtureActionDefaults = {
        expectedSiteChange: true
    };
    [
        ...
        },
        {
            ...
            "aActionSequence": [
                { "moveGroup": { source: "Group number one", beforeGroup: "Substituted group title" } }
            ],
            "expectedDelta": {
                        "_version": "3.0.0",
                        "groupOrder": [
        ...
        asyncTest("CDM Black Box Test on '" + oFixture.sOriginalSiteFileName.split("/")
            .pop() + "' returns the correct result when the Action Sequence is: " + oFixture.testDescription, function () {
    ...
    //Black Box Testing for CDM ends.

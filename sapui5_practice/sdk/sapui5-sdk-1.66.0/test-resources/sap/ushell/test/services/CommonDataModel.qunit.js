...
sap.ui.require([
    ...
    /*global Promise asyncTest deepEqual module notStrictEqual ok parseInt start
      stop sinon strictEqual jQuery sap window QUnit */
            ...
            return jQuery.when( {
                applications: {
                    plugin_0: {
                        ...
                        "sap.ui5": {
                            componentName: "plugin_0_component"
                        },
                    ...
                    plugin_1: {
                        ...
                        "sap.ui5": {
                            componentName: "plugin_1_component"
                        },
                        "sap.platform.runtime": {
                            "componentProperties": {
                                url: "http://",
            ...
            return jQuery.when( {
                applications: {
                    ...
                    plugin_2: {
                        ...
                        "sap.ui5": {
                            componentName: "plugin_2_component"
                        },
                        "sap.platform.runtime": {
                            "componentProperties": {
                                url: "http://",
                    ...
                    plugin_3: {
                        ...
                        "sap.ui5": {
                            componentName: "plugin_3_component"
                        },
                        "sap.platform.runtime": {
                            "componentProperties": {
                                url: "http://",
                                "config": {
                                    "sap-ushell-plugin-type": "UnsupportedCategory"
                                }
                            }
                        }
                    },
                    ...
                    plugin_4: {
                        ...
                        "sap.ui5": {
                            componentName: "plugin_4_component"
                        }
                    },
                    ...
                    plugin_5: {
                        ...
                        "sap.ui5": {
                            componentName: "plugin_5_component"
                        }
                    },
                    ...
                    plugin_6: {
                        ...
                        "sap.ui5": {
                            componentName: "plugin_6_component"
                        },
                        "sap.platform.runtime": {
                            "componentProperties": {
                                url: "http://"
                    ...
                    plugin_7: {
                        ...
                        "sap.ui5": {
                            componentName: "plugin_7_component"
                        },
                        "sap.platform.runtime": {
                            componentProperties: {
                                url: "http://",
                    ...
                    plugin_8: {
                        ...
                        "sap.ui5": {
                            componentName: "plugin_8_component"
                        },
                        "sap.platform.runtime": {
                            componentProperties: {
                                url: "http://",
                                config: {
                                    "param1": "valueFromConfig"
                                }
                            }
                        }
                    }
            ...
            .then( function ( oPlugins ) {
                assert.deepEqual( oPlugins, {
                    ...
                    plugin_8: {
                        ...
                        config: {
                            // value from signature takes precedence
                            "param1": "valueFromInbound"
                        }
                    }
                ...
                applications: {
                    plugin: {
                        "sap.app": {
                            ...
                            crossNavigation: {
                                inbounds: {
                                    "InboundId": {} // note: not Shell-plugin
                                }
                            }
                        },
                        "sap.flp": {
    ...
    asyncTest("save: undefined extracted personalization data ", function () {
        ...
        oStorePersonalizationDataStub = sinon.stub(oCommonDataModelService._oAdapter, "_storePersonalizationData", function () {
        ...
        oCommonDataModelService.save()
            .done(function () {
                ...
                ok(oStorePersonalizationDataStub.calledWith({
                    "foo": "bar"
                }), "_storePersonalizationData was called with correct personalization delta.");
                ok(oCommonDataModelService._oPersonalizationProcessor.extractPersonalization.called, "extractPersonalization called as expected.");
                oStorePersonalizationDataStub.restore();
                oCommonDataModelService._oPersonalizationProcessor.extractPersonalization.restore();
            })
    ...
    asyncTest("save: _storePersonalizationData rejects", function () {
        var oCommonDataModelService,
            oStorePersonalizationDataStub;
        ...
        oCommonDataModelService.save()
            ...
            .fail(function (sMessage) {
                start();
                ok(oStorePersonalizationDataStub.called, "_storePersonalizationData called as expected.");
                ok(oCommonDataModelService._oPersonalizationProcessor.extractPersonalization.called, "extractPersonalization called as expected.");
    ...
    (function () {
        ...
        function createFakeContentProviders(oContentProvidersConfig) {
            ...
            if (oContentProvidersConfig.create.fromGetSiteImplementations) {
                ...
                /*
                 * We want to control the order in which promises are finalized
                 * based on the configured finalizeGetSitePromiseOrder if any. So
                 * we collect bound promise callbacks in this array which we
                 * process after the last promise is added to it.
                 */
         ...
         *
         * @param {object} oCommonDataModelService
         *  An object representing the CommonDataModel service
         *
         * @param {object} oContentProvidersConfig
         *  Instructions on how to create multiple content providers. This is an object like:
         *
         *  <pre>
         *  {
         *      ids: "auto" // or array of ids to use,
         *      finalizeGetSitePromiseOrder: [4, 1],  // (optional) if provided causes the
         *                             // content providers to resolve/reject with the
         *                             // extension site in the given order. In
         *                             // the example here, the first site
         *                             // resolves (or rejects) after the
         *                             // second site (because 4 > 1).
         *                             // This option is only effective when
         *                             // providers are created via // using
         *                             // 'fromSiteOrErrors'.
         *      create: {
        ...
        [
            // These tests ensure that getExtensionSites behaves as expected for
            // different behaviors of loadContentProviderPlugins.
            {
            ...
            },
            {
                ...
                oContentProvidersSpecs: {
                    ...
                    create: {
                        fromSiteOrErrors: [
                            "intentionally failed"   // failing site provided as string
                        ]
                    }
                },
                expectedExtensionSites: [
        ...
        [
            ...
            },
            {
                ...
                expectedErrorLogCalls: [
                    "a content provider with ID 'ProviderId' is already registered"
                ],
                expectedExtensionSites: [
                    {
            ...
            },
            {
                ...
                expectedErrorLogCalls: [
                    "One or more apps from Provider1 content provider are not listed among the applications section of the extended site and will be discarded - From catalog 'MyCatalog': 'sap.nonexisting.app'"
                ],
                expectedExtensionSites: [
                    {
                        providerId: "Provider1",
            ...
            },
            {
                ...
                expectedErrorLogCalls: [
                    "One or more apps from Provider1 content provider are not listed among the applications section of the extended site and will be discarded - From catalog 'MyCatalog1': 'sap.nonexisting.app1'; From catalog 'MyCatalog2': 'sap.nonexisting.app2', 'sap.nonexisting.app3'"
                ],
                expectedExtensionSites: [
                    {
                        success: true,
            ...
            asyncTest("getExtensionSites: resolves promise as expected when " + oFixture.testDescription, function () {
                ...
                commonArrange(oCommonDataModelService, {
                    ...
                    finalizeGetSitePromiseOrder: oFixture.testFinalizeGetSitePromiseOrder
                        || oFixture.aSitesFromContentProviders.map(function (o, iIdx) {
                            return iIdx;
                        }),
                    create: {
                        fromSiteOrErrors: oFixture.aSitesFromContentProviders
                    }
                });

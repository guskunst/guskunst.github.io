...
function (utils, System, oUi5ServiceFactory, oUi5NativeServiceFactory, ServiceFactoryRegistry, testUtils, OData, Ui5NativeServiceFactory) {
    "use strict";
    /*global Promise asyncTest deepEqual module ok throws start
     strictEqual stop test acme dispatchEvent document jQuery notStrictEqual
     QUnit sap setTimeout sinon Storage window */
    ...
    [
        {
            sTestDescirption: " hasFLPReadyNotificationCapability is false",
            bHasFLPReadyNotificationCapability: false,
            bExpectedDoEventFlpReadyCalled: false
        },
        {
            sTestDescirption: " hasFLPReadyNotificationCapability is true",
        ...
        asyncTest("initialize Container", function () {
            ...
            .done(function () {
                ...
                setTimeout(function () {
                    strictEqual(bDoEventFlpReadyCalled, oFixture.bExpectedDoEventFlpReadyCalled, "doEventFlpReady was called/not called as expected when" + oFixture.sTestDescirption);
                    start();
                }, 0);
            });
        });
    ...
    function testCreateRenderer (sConfigRenderer, sParamRenderer, bAsync, done) {
        ...
        return sap.ushell.bootstrap("local").fail(testUtils.onError).done(function () {
            ...
            if (bAsync) {
                // check if the call returned a Promisse
    ...
    test("getServiceAsync with parameter", function (assert) {
        ...
        sap.ushell.bootstrap("local").fail(testUtils.onError).done(function () {
            ...
            oBarService.then(function (oBarService) {
                ...
                strictEqual(oRequireStub.getCalls().length, 2, "require was called twice");
            ...
            .then(function (oBarService2) {
                ...
                strictEqual(oRequireStub.getCalls().length, 2, "require was not called further");
            ...
            .then(function (oBarService3) {
                notStrictEqual(oBarService3, oBarServiceBackup,
                    "new instance for different parameter");
                strictEqual(oRequireStub.getCalls().length, 4, "require was called four times");
                done();
            });
        });
    });

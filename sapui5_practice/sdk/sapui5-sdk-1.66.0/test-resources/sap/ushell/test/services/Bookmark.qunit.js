...
sap.ui.require([
...
], function (Bookmark, testUtils) {
    "use strict";
    /*global asyncTest, deepEqual, module, notStrictEqual, ok, start, strictEqual, test, jQuery, sap, sinon */
    ...
    test("addBookmarkByGroupId", function () {
    ...
    asyncTest("getGroupsIdsForBookmarks", function () {
        ...
        oLaunchPageService.getGroupsForBookmarks = function () {
            return (new jQuery.Deferred()).resolve([
                {id: "1", title: "group1", object: {id: 1}},
                {id: "2", title: "group2", object: {id: 2}},
                {id: "3", title: "group3", object: {id: 3}}
            ]).promise();
        };
        ...
        oBookmarkService.getShellGroupIDs().done(function (aGroups) {
            ...
            deepEqual(aGroups[0], {"title": "group1", "object": {"id": 1, "title": "group1"}});
            deepEqual(aGroups[1], {"title": "group2", "object": {"id": 2, "title": "group2"}});
            deepEqual(aGroups[2], {"title": "group3", "object": {"id": 3, "title": "group3"}});

...
sap.ui.require([
...
], function (utils, Personalization, PersonalizationContainerVariant, VariantSetAdapter, ContextContainer, Variant) {
    "use strict";

    /*jslint nomen: true*/
    /*global Promise asyncTest QUnit deepEqual equal module ok start stop test sinon jQuery sap assert */
    ...
    test("AppContainerVariant: create a variant with a non-string key", function () {
        ...
        try {
            var oVariant = new PersonalizationContainerVariant(sVariantKey, sVariantName, {});
...
//        try {
//            oVariant = new PersonalizationContainerVariant(sVariantKey, sVariantName, oVariantData);

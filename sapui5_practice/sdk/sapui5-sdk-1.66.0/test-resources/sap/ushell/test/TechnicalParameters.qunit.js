...
sap.ui.require([
    ...
    QUnit.test("getParameterNames: returns all the technical Parameters", function (assert) {
        // Arrange
        var aExpectedResult = ["sap-navigation-scope", "sap-fiori-id", "sap-ui-fl-max-layer", "sap-ui-fl-control-variant-id", "sap-ui-app-id-hint", "sap-ach"],
            aReturnedResult = [];
    ...
    QUnit.test("Calls getParameters with oFilterOptions=undefined", function (assert) {
        ...
        // Assert
        assert.strictEqual(aResult.length, 6, "The correct number of parameters is returned");
    });

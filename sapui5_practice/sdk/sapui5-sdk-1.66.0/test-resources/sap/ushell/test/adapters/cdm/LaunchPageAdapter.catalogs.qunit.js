...
sap.ui.require([
...
], function (testUtils , utils, LaunchPageAdapter, oContainer, GenericTile, Link, oUtils, navigationMode, oReadVisualization) {
    "use strict";
    /* global assert Promise asyncTest deepEqual strictEqual module ok sinon start test jQuery sap QUnit */
    ...
    QUnit.test("getCatalogTileView: Get tile view for custom tile", function (assert) {
        ...
        var oFakeComponent = { id: "FakeComponent" },
            ...
            oComponentContainerStub = sinon.stub(sap.ui.core, "ComponentContainer").returns(oFakeComponentContainer),

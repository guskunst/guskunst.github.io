...
sap.ui.require([
    ...
    "sap/ushell/EventHub",
    "sap/ushell/Config"
], function (AppLifeCycle, Container, EventHub, Config) {
    "use strict";
    ...
    test("Constructor Test", function () {
        ...
        var text = "application title",
            shellAppTitle = new sap.ushell.ui.shell.ShellAppTitle({text: text}),
    ...
    QUnit.test("getControlVisibilityAndState Test", function (assert) {
        ...
        sap.ushell.bootstrap("local").then(function () {
            var oNavMenu = {},
                ...
                oShellAppTitle = new sap.ushell.ui.shell.ShellAppTitle({ text: "text" }),
            ...
            bTitleVisible = oShellAppTitle._getControlVisibilityAndState(oNavMenu, oControl);

            ok(bTitleVisible === true, "bTitleVisible is true when: 1.Shell state is home, 2._isNavMenuEnabled = true, 3.AllMyAppsEnabled = true");
            ...
            ok(oSetPropertySpy.args[0][1] === oStateEnum.SHELL_NAV_MENU, "Model property ShellAppTitleState was set to SHELL_NAV_MENU");
            ...
            ok(oSetPropertySpy.calledOnce === true, "Model setProperty called once");
            ok(oSetPropertySpy.args[0][0] === "/ShellAppTitleState", "setProperty for ShellAppTitleState was called");
            ok(oSetPropertySpy.args[0][1] === oStateEnum.SHELL_NAV_MENU_ONLY, "Model property ShellAppTitleState was set to SHELL_NAV_MENU_ONLY");
            ...
            ok(bTitleVisible === true, "bTitleVisible is true when: 1.Shell state is app, 2._isNavMenuEnabled = false, 3.AllMyAppsEnabled = true");
            ok(oSetPropertySpy.calledOnce === true, "Model setProperty called once");
            ok(oSetPropertySpy.args[0][0] === "/ShellAppTitleState", "setProperty for ShellAppTitleState was called");
            ...
            ok(bTitleVisible === false, "bTitleVisible is false when: 1.Shell state is  not app|home, 2._isNavMenuEnabled = false, 3.AllMyAppsEnabled = true");
            ok(oSetPropertySpy.calledOnce === true, "Model setProperty called once");
            ok(oSetPropertySpy.args[0][0] === "/ShellAppTitleState", "setProperty for ShellAppTitleState was called");
            ok(oSetPropertySpy.args[0][1] === oStateEnum.SHELL_NAV_MENU_ONLY, "Model property ShellAppTitleState was set to SHELL_NAV_MENU_ONLY");
    ...
    test("popoverBackButton Test", function () {
        var oShellAppTitle = new sap.ushell.ui.shell.ShellAppTitle({text: "text"}),
        ...
        oAllMyAppsPopoverStub = sinon.stub(oShellAppTitle, "_getAllMyAppsPopover").returns({
        	close : oAllMyAppsPopoverCloseSpy
        });
        oNavMenuPopoverStub = sinon.stub(oShellAppTitle, "_getNavMenuPopover").returns({
        	openBy : oNavMenuPopoverOpenBySpy
        });
        ...
        ok(oModelSetPropertyStub.args[0][0] === "/ShellAppTitleState", "Back from AllMyApps: Model setProperty called for property ShellAppTitleState");
        ok(oModelSetPropertyStub.args[0][1] === oStateEnum.SHELL_NAV_MENU, "Back from AllMyApps: Model setProperty called for setting ShellAppTitleStat to SHELL_NAV_MENU");
        ...
        ok(oHandleSwitchToMasterAreaOnPhoneSpy.calledOnce === true, "Back from DETAILS state on Phone: handleSwitchToMasterAreaOnPhone called");

        sap.ui.Device.system.phone = oOrigDeviceSystemPhone;
        oAllMyAppsPopoverStub.restore();
        oNavMenuPopoverStub.restore();
    ...
    QUnit.test("Renderer Test", function (assert) {
        ...
        EventHub.once("RendererLoaded").do(function () {
            ...
            EventHub.join(
                ...
                // Sometimes the test runs before the initial title got set, leading to the title set by the test being overwritten by e.g. "Home"

...
(function () {
	...
	jQuery.sap.require("sap.ushell.ui.fiori3.ShellHeader");
    ...
    module("sap.ushell.ui.shell.ShellLayout", {
        setup: function () {
            ...
            oShellHeader = new sap.ushell.ui.fiori3.ShellHeader({
                id: 'shell-header',
            ...
            oShellHeader2 = new sap.ushell.ui.fiori3.ShellHeader({
                title: oShellHeaderTitle2,
                searchState: sap.ushell.ui.fiori3.ShellHeader.prototype.SearchState.COL,
                logo: "../icon.png"
            });
    ...
    test("Properties - Default Values", function () {
        ...
        equal(oShell.getHeader().getSearchState(), sap.ushell.ui.fiori3.ShellHeader.prototype.SearchState.COL, "Default 'searchVisible'");
    ...
    test("Properties - Custom Values", function () {
        ...
        equal(oShell2.getHeader().getSearchState(), sap.ushell.ui.fiori3.ShellHeader.prototype.SearchState.COL, "Custom 'searchVisible'");
	...
	test("Shell Header Types", function () {
		...
		ok(oHeader instanceof sap.ushell.ui.fiori3.ShellHeader, "Header type is correct");

...
sap.ui.require([
    ...
    "sap/ushell/ui/fiori3/ShellHeader",
    "sap/ushell/ui/shell/ShellAppTitle",
    "sap/ushell/ui/shell/ShellTitle",
    "sap/ushell/ui/shell/ShellHeadItem"
], function (jQuery, IconPool, ShellHeader, ShellAppTitle, ShellTitle, ShellHeadItem) {
    "use strict";
    ...
    QUnit.module("basic test", {
        beforeEach: function (assert) {
            ...
            oShellHeader = new ShellHeader("shell-header", {
                ...
                title: new ShellTitle("shellTitle", { text: "Subtitle with a long text" }),
    ...
    QUnit.test("Logo linked if not on homepage, navigate home", function (assert) {
        ...
        var oDelegate = {
            onAfterRendering: function () {
                ...
                assert.equal(jQuery(".sapUshellShellIco").attr("role"), "button", "Role is set correct for logo");
    ...
    QUnit.test("Logo not linked on homepage", function (assert) {
        ...
        var oDelegate = {
            onAfterRendering: function () {
                assert.notOk(jQuery(".sapUshellShellIco").attr("href"), "Logo is not linked");
                assert.notOk(jQuery(".sapUshellShellIco").attr("tabindex"), "tabindex is not set");
                assert.notOk(jQuery(".sapUshellShellIco").attr("role"), "role is not set");
                assert.notOk(jQuery(".sapUshellShellIco").attr("aria-label"), "aria-label is not set");
                oShellHeader.removeDelegate(oDelegate);
                done();
            }
        };
    ...
    QUnit.test("Rendering", function (assert) {
        ...
        assert.ok(jQuery(".sapUshellShellHeadSubtitle .sapUshellHeadTitle").text() === oShellHeader.getTitle().getText(), "Title is rendered");
    ...
    QUnit.test("Test that accessibility property is set correctly", function (assert) {
        ...
        assert.equal(jQuery("#shell-header").attr("role"), "banner", "The header role is banner");

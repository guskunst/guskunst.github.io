...
sap.ui.require([
    ...
    QUnit.test("Default Values", function (assert) {
        ...
        assert.strictEqual(this.oGridContainer.getHeaderLevel(), sap.m.HeaderLevel.H2, "Default 'headerLevel' value is sap.m.HeaderLevel.H2");
        assert.strictEqual(this.oGridContainer.getGroupHeaderLevel(), sap.m.HeaderLevel.H4, "Default 'groupHeaderLevel' value is sap.m.HeaderLevel.H4");
    ...
    QUnit.test("Creates a sap.f.GridContainer instance with no special properties for the layoutM aggregation", function (assert) {
        // Arrange
        var oSettings = this.oGrid.getLayoutM();

        // Act
        // Assert
        assert.strictEqual(oSettings, null, "No special settings for layoutM was provided.");
    });
    ...
    QUnit.test("Creates a sap.f.GridContainer instance with correct properties for the layoutL aggregation", function (assert) {
        ...
        // Act
        // Assert
        assert.strictEqual(oSettings, null, "No special settings for layoutL was provided.");
    });
    ...
    QUnit.test("Creates a sap.f.GridContainer instance with correct properties for the layoutXL aggregation", function (assert) {
        ...
        // Act
        // Assert
        assert.strictEqual(oSettings, null, "No special settings for layoutXL was provided.");
    });

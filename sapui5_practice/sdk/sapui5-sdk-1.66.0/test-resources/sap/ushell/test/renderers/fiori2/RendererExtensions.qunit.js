...
(function () {
    ...
    asyncTest("Add tool area item without states", function() {
    ...
    asyncTest("test add Tool Area Item to app state", function () {
    ...
    asyncTest("test add Tool Area Item to home state", function () {
    ...
    asyncTest("test removeToolAreaItem without states", function () {
        var oRenderer = sap.ushell.Container.getRenderer("fiori2");
    ...
    [
        ...
        asyncTest("test removeToolAreaItem from different states " + oFix.description, function () {
            var oRenderer = sap.ushell.Container.getRenderer("fiori2");
    ...
    test("test addHeaderItem the second time - with all state", function () {
        var warningSpy = sinon.spy(jQuery.sap.log, "warning");
        var headItem1 = new sap.ushell.ui.shell.ShellHeadItem("firstItemAppstate");
        var headItem2 = new sap.ushell.ui.shell.ShellHeadItem("secondItemAppstate");
        var rendererExt = sap.ushell.renderers.fiori2.RendererExtensions;
        rendererExt.addHeaderItem(headItem1);

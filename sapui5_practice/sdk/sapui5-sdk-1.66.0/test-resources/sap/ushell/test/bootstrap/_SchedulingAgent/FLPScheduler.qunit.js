...
sap.ui.require([
    ...
    // Include additional objets and functions that will be called in the internal state
    state.id = {
        module : {
            state : {
                id : "INTERNAL_STATE",
    ...
    QUnit.module("API - getNextLoadingStep", {
        beforeEach: function () {
            ...
            //FLPScheduler.oSchedule.oBlocks["FLPPlugins"].iStepIndex = 0;
        },
        afterEach: function () {
            //this.oGetLoadingScheduleStub.restore();

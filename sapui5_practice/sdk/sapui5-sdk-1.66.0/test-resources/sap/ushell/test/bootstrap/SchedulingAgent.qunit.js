...
sap.ui.require([
    ...
    // Bring the interfaces up to date. Thisneeds to be removed once everything s merged.
    FLPScheduler.initializeSchedule = function () {};
    state.setForModule = function () {};
    state.setForLoadingStep = function () {};
    state.initialize = function () {};
    EventProcessor.initializeStepDoneListener = function () {};
    FLPLoader.loadComponentByEvent = function () {};
    logger.dumpHistory = function () {};
    ...
    state.id = {
        module : {
            schedulingAgent : {
                ...
                FatalError: "ERROR", // Export!
                Done: "FINISHED" // Export!
            },
            state : {
                id : "INTERNAL_STATE",
                Initializing : "INITIALIZING",
    ...
    QUnit.test("If the step is waitInMs, call the FLPLoader", function (assert) {
        ...
        assert.ok(this.oSetForStep.calledWith("under Pressure", state.id.loadingStep.InProgress, oStepConfig.oData), "Step updated to in progress.");

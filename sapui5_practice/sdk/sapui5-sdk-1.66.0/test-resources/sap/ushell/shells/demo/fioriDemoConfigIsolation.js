...
//                            icon: "sap-icon://flight",
        ...
        applications: {
            ...
            "Action-todefaultapp" : {
                applicationType: "URL",
                url: sUshellTestRootPath + "/shells/demo/ui5appruntime.html?sap-ui-app-id=sap.ushell.demo.FioriSandboxDefaultApp#Action-todefaultapp",
                description : "Navigation App - Isolated",
                navigationMode: "embedded"
            },
            "Action-toLetterBoxing": {
                applicationType: "URL",
                url: sUshellTestRootPath + "/shells/demo/ui5appruntime.html?sap-ui-app-id=sap.ushell.demo.letterBoxing#Action-toLetterBoxing",
                description : "LetterBoxing demo app - Isolated",
                navigationMode: "embedded"
            },
            "Action-toappnavsample": {
                applicationType: "URL",
                url: sUshellTestRootPath + "/shells/demo/ui5appruntime.html?sap-ui-app-id=sap.ushell.demo.AppNavSample#Action-toappnavsample",
            ...
            "FioriToExtAppIsolated-Action" : {
                applicationType: "URL",
                url: sUshellTestRootPath + "/shells/demo/ui5appruntime.html?sap-ui-app-id=sap.ushell.demo.FioriToExtApp#FioriToExtApp-Action",
                description : "App Source (Isolated)",
                navigationMode: "embedded"
            },
            "FioriToExtAppTargetIsolated-Action" : {
                applicationType: "URL",
                url: sUshellTestRootPath + "/shells/demo/ui5appruntime.html?sap-ui-app-id=sap.ushell.demo.FioriToExtAppTarget#FioriToExtAppTarget-Action",
                description : "App Target (Isolated)",
                navigationMode: "embedded"
            },
            "BookmarksIsolated-Action" : {
                applicationType: "URL",
                url: sUshellTestRootPath + "/shells/demo/ui5appruntime.html?sap-ui-app-id=sap.ushell.demo.bookmark#BookmarkSample-Action",
                description : "Bookmarks (Isolated)",
                navigationMode: "embedded"
            },
            "Action-toappcontextsample" : {
                applicationType: "URL",
                url: sUshellTestRootPath + "/shells/demo/ui5appruntime.html?sap-ui-app-id=sap.ushell.demo.AppContextSample#Action-toappcontextsample",

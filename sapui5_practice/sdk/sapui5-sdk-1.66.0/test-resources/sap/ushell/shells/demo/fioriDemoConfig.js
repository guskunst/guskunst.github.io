...
//                            icon: "sap-icon://flight",
    ...
    var generateGroups = function(nNumberGroups, nNumberTileInEachGroups) {
        ...
        console.log(sap.ushell.shells.demo.testContent.groups);
...
//                            icon: "sap-icon://flight",
    ...
    //generateGroups(50, 50);

    var generateCatalogs = function(nNumberCatalogs, nNumberTileInEachCatalog) {
        var iCatalogInd = 0, iTileIndex = 0;
        console.log(sap.ushell.shells.demo.testContent.catalogs);

        for (iCatalogInd = 0; iCatalogInd < nNumberCatalogs; iCatalogInd++) {
            var oGeneratedGroup = {
                id: "generated" + iCatalogInd,
                tiles: [],
                title: "generated" + iCatalogInd
            };
            sap.ushell.shells.demo.testContent.catalogs.push(oGeneratedGroup);

            for (iTileIndex = 0; iTileIndex < nNumberTileInEachCatalog; iTileIndex++) {
                var oGenTile = {
                    chipId: "genCatalogTile_" + iCatalogInd + "-" + iTileIndex,
                    title: "Generated " + iCatalogInd + " - " + iTileIndex,
                    size: "1x1",
                    tileType: "sap.ushell.ui.tile.DynamicTile",
                    isLinkPersonalizationSupported: true,
                    keywords: ["risk", "neutral", "account"],

...
sap.ui.require([
    ...
    "sap/m/MessageToast"
], function (ShellHeader, ShellHeadItem, ShellTitle, ShellAppTitle,
    ContainerMock, FixFlex, MessageToast) {
    "use strict";
    ...
    sap.ui.jsview("sap.ushell.playground.view.ShellHeaderPlayground", {
        ...
        _createPage: function () {
            ...
            var oShellTitleLabel = new sap.m.Label({
                text: "Shell Title",
                labelFor: oShellTitleText
            });

            var oShellHeaderTitle = new ShellTitle({
                text: "{/shellTitle}",
                press: function () {
                    MessageToast.show("Shell Title");
                }
            });

            var oShellTitleText = new sap.m.Input({
                type: sap.m.InputType.Text,
                placeholder: "Enter a shell title ...",
                submit: function (oEvent) {
                    if (!oShellTitleText.getValue() == "") {
                        oShellHeader.setAggregation("title");
                        oShellHeader.setTitle(oShellHeaderTitle);
                    } else {
                        oShellHeader.setAggregation("title");
                    }
                }
            });
            oShellTitleText.bindValue("/shellTitle");
            ...
            var oEditableSimpleForm = new sap.ui.layout.form.SimpleForm({
                ...
                content: [oShellHeaderVsbLabel, oShellHeaderSwitch, oLogoLabel, oLogoSwitch, oLogoSelect, oHeadItemLabel, oHeadItemAddBtn,
                    ...
                    oHeadEndItemRemoveBtn, oShellTitleLabel, oShellTitleText, oShellAppTitleLabel, oShellAppTitleText
                ]
            });

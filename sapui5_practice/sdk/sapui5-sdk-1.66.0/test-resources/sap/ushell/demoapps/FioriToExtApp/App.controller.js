...
sap.ui.define([
    ...
    function (MessageToast, ShellNavigationHashChanger) {
        "use strict";
        ...
        sap.ui.controller("sap.ushell.demo.FioriToExtApp.App", {
            ...
            on_getFLPUrl: function() {
                ...
                sap.ushell.Container.getFLPUrl(true).done(function (result) {
                    ...
                    that.getView().getModel().setProperty("/param_getFLPUrl", actResult);
                });
            },

            on_getFLPUrlSync: function() {
                var that = this, actResult;

                var result = parent.window.document.location.href;
                ...
                that.getView().getModel().setProperty("/param_getFLPUrlSync", actResult);
            },

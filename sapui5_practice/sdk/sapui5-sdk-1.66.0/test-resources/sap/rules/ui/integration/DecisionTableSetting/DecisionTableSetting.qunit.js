...
sap.ui.require(
	...
	function(opaTest, Opa5, Utils, onDecisionTablePage, onTheSettingsPage) {
		...
		var sRuleId = "70b37e4361934a5d9282150ba880a6bf", //"005056A7004E1EE6AFA3E4918F7BFB7A",
		...
		*/
		opaTest("New Rule Settings scenario: Check the existence of a default column , result columns and a default row ", function(Given, When, Then) {
			...
			Then.onTheSettingsPage.iTestLayoutContent("Then: Layout contains all controls", sViewName).and
				...
				.iSeeMessageStrip("Selecting Access as Hidden will set the default value to ALL the rows in the decision table.").and
				.iSeeMessageStrip("Selecting Access as Editable will set the default value to only NEW rows created after choosing Apply.");
		...
		*/
		...
		opaTest("Update Rule scenario: Check Change Result  ", function(Given, When, Then) {
			...
			Then.onDecisionTablePage
				.iCheckNumOfColumns("Then: Check num of columns", "myDecisionTable", 4, sRulePath, sViewName);
		});

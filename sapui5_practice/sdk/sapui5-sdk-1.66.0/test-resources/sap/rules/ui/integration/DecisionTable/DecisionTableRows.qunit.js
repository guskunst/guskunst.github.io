...
sap.ui.require([
	...
	opaTest("Line Actions", function(Given, When, Then) {
		...
		Then.onDecisionTablePage.iCanSeeTheValueByIndex("COPY - PASTE Check value in copied row", 2, 0, "='Pride and Prejudice'");
		...
		Then.onDecisionTablePage.iCanSeeTheValueByIndex("COPY - INSERT BEFORE Check value in copied row", 2, 0, "='Harry Potter'");
		...
		Then.onDecisionTablePage.iCanSeeTheValueByIndex("COPY - INSERT AFTER Check value in copied row", 4, 0, "='Harry Potter'");
		...
		Then.onDecisionTablePage.iCanSeeTheValueByIndex("CUT - INSERT BEFORE Check value in copied row", 4, 0, "='Harry Potter'");
		...
		Then.onDecisionTablePage.iCanSeeTheValueByIndex("CUT - INSERT AFTER Check value in copied row", 3, 0, "='Pride and Prejudice'");
		...
		Then.onDecisionTablePage.iCanSeeTheValueByIndex("CUT - PASTE Check value in copied row", 1, 0, "='Harry Potter'");

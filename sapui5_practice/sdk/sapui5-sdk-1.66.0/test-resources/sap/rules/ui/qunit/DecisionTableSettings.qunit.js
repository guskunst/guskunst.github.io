       ...
       //QUnit.begin(function () {
		QUnit.module( "Test Refresh", {
            beforeEach: function() {
				...
				this.updatesStrMessageExpected = "Columns 'nameD' were added.Columns 'nameB' were changed.Columns 'nameC' were removed.Refreshing will delete all the values in the removed columns.Are you sure you want to continue?";

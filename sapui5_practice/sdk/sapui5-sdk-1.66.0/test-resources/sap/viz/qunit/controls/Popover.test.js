...
QUnit.test("Check small data point." , function( assert ) {
  ...
  var checkSmallDataPoint = function(e){
    ...
    assert.equal($('.viz-controls-chartPopover-measure-labels >span').text(), "80", "Measure value should be correct.");
...
QUnit.test("Check bullet data point." , function( assert ) {
  ...
  var checkSmallDataPoint = function(e){
    ...
    assert.equal($('.viz-controls-chartPopover-measure-labels >span')[0].textContent, "45.3", "Measure value should be correct.");
    assert.equal($('.viz-controls-chartPopover-measure-labels >span')[1].textContent, "73.2", "Measure value should be correct.");
...
QUnit.test("check Time format." , function( assert ) {
  ...
  var checkTimeFormat = function(e){
    ...
    assert.equal($('.viz-controls-chartPopover-measure-labels >span')[0].innerText, "Jan 2, 2015", "Follows chart's tooltip format");
...
QUnit.test("check Time format with Popover's formatString." , function( assert ) {
  ...
  var checkTimeFormat = function(e){
    assert.equal(this.getPlacement(), 'VerticalPreferredTop', 'Popover should be opened with VerticalPreferredTop.');
    assert.equal($('.viz-controls-chartPopover-measure-labels >span')[0].innerText, "2015-01-02", "Follows chart's tooltip format");
...
QUnit.test("check unitBinding" , function( assert ) {
  ...
  var checkUnitBinding = function(e){
    assert.equal($('.viz-controls-chartPopover-measure-labels >span')[1].innerText, "w", "unitBinding is correct displayed in Popover");
    done();
  };

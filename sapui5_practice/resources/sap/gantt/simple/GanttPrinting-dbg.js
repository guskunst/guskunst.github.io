...
sap.ui.define([
	...
	function (
		...
		GanttPrinting.prototype.setGanttChart = function (oGanttChart) {
			...
			// Because of Models
			this._ganttChartContainer.setParent(this._getOriginalGanttChart(), "originalGanttChart");
		...
		GanttPrinting.prototype._drawClonedGantt = function () {
			...
			var _oRM = sap.ui.getCore().createRenderManager();
			_oRM.renderControl(this._ganttChartContainer);
			_oRM.flush(this._oClonedGanttDiv);
			_oRM.destroy();
			this._ganttChartContainer.rerender();

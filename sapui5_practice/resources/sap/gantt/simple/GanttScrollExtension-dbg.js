...
sap.ui.define([
	...
	GanttScrollExtension.prototype.needRerenderGantt = function(fnRedrawGanttChart) {
		...
		var bRowsHeightChanged = this.getGantt().getSyncedControl().getRowsHeightChanged();

		if (this.mOffsetWidth && this.doesSvgScrollWithinBuffer() && !bRowsHeightChanged) {

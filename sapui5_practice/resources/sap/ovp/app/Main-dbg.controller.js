sap.ui.define(["sap/ui/core/mvc/Controller", "sap/m/library", "sap/ui/model/odata/ODataUtils", "sap/ovp/cards/generic/Component",
        ...
        "sap/m/BackgroundDesign", "sap/m/ListSeparators", "sap/ui/core/TextAlign", "sap/ovp/support/lib/CommonMethods", "sap/ovp/app/resources", "sap/ovp/app/TemplateBaseExtension", "sap/ui/core/mvc/ControllerExtension", "sap/ovp/cards/loading/State"],
    ...
    function (Controller, SapMLibrary, ODataUtils, Component, NavigationHandler, MessageBox, CommonUtils, PersonalizationUtils,
              ...
              TemplateBaseExtension, ControllerExtension, LoadingState) {
            ...
            fVerifyAndSetErrorOrCustomMessageCard: function (oReason, bSuccess) {
                ...
                for (key in this.aOrderedCards) {
                    ...
                    if (oCardItemsBinding) {
                        ...
                        if (oManifestCard && this.aErrorCards.indexOf(sCardId) == -1 && !sModelUrl) {
            ...
            verifyGlobalFilterLoaded: function () {
                ...
                if (oGlobalFilter.search()) {
                    if (oGlobalFilter.validateMandatoryFields()) {
                        LoadingState.GLOBALFILTERFILLED = true;
                        return true;
                    }
                }
                this.getView().byId("ovpMain").setHeaderExpanded(true);
                LoadingState.GLOBALFILTERFILLED = false;
                return false;
            },

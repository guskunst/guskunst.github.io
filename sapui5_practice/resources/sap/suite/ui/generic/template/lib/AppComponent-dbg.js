...
sap.ui.define([
	...
	"sap/base/Log"
], function(jQuery, UIComponent, NavContainer, FlexibleColumnLayout, Filter, FilterOperator, MessageScope, JSONModel, ResourceModel, ApplicationController,
	...
	function getMethods(oAppComponent, oAppId) {
		...
		function init(){
			...
			var oMessageScopSupportedPromise = Promise.resolve(false) || oModel.messageScopeSupported(); // disabled until final questions are clarified

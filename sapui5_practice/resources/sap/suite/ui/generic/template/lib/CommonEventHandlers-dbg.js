...
//			}
		...
		function onDiscardDraft(oEvent, oSaveScenarioHandler) {
			...
			oServices.oApplication.performAfterSideEffectExecution(function(){
				...
				var bIsDraftModified = oServices.oApplication.getIsDraftModified(sPath) || oSaveScenarioHandler.hasValidationMessageOnDetailsViews();

			...
			if (sFilterRestriction === 'multiple') {
				...
				if (oContext.ranges) {
					for (var i = 0; i < oContext.ranges.length; i++) {
						...
						} else if (oRange.exclude && (oRange.operation === 'EQ' || oRange.operation === 'Empty')) { // _IS_OTHER

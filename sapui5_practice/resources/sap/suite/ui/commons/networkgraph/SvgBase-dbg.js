...
sap.ui.define([
	...
	SvgBase.prototype._renderHtmlIcon = function (sIcon, sClass, sId, sAttr) {
		var oIconInfo = IconPool.getIconInfo(sIcon),
			sFontFamily = "";
		...
		if (oIconInfo) {
			...
			return "<div " + sId + " " + (sAttr || "") + "class=\"sapSuiteUiCommonsNetworkGraphIcon " + sClass + "\"><span " + sFontFamily + ">" + encodeXML(oIconInfo.content) + "</span></div>";
		}

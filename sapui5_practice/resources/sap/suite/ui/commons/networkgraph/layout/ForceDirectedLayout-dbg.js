...
sap.ui.define([
	 ...
	 * @public
	 * @since 1.58
	 * @alias sap.suite.ui.commons.networkgraph.layout.ForcedDirectedLayout
	 */
	...
	ForceDirectedLayout.prototype.layout = function () {
		return new LayoutTask(function (fnResolve, fnReject, oLayoutTask) {
			...
			Measurement.start("NetworkGraph - ForcedDirectedLayout", "Layouting of a graph " + oGraph.getId());

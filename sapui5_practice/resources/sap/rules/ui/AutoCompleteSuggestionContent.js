sap.ui.define([
	...
	"sap/rules/ui/ast/autoCompleteContent/AutoSuggestionVocabularyRulesPanel",
...
], function (jQuery, library, Control, List, JSONModel, AutoSuggestionVocabularyPanel, AutoSuggestionVocabularyRulesPanel, AutoSuggestionFixedValuePanel,
	...
	AutoSuggestionSelectFunctionPanel) {
	"use strict";
	...
	var AutoCompleteSuggestionContent = Control.extend("sap.rules.ui.AutoCompleteSuggestionContent", {
		...
		_getAutoSuggestionList: function () {
			...
			if (this.rules && this.rules.length > 0) {
				this.rules = this._handleMissingLabels(this.rules);
				var rulesPanel = new sap.rules.ui.ast.autoCompleteContent.AutoSuggestionVocabularyRulesPanel({
					reference: that._reference,
					dialogOpenedCallbackReference: that._dialogOpenedCallbackReference,
					data: that.rules,
					context: that.suggestionContext

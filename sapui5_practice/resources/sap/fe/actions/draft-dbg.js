...
sap.ui.define(['sap/fe/factory/UI5ControlFactory', 'sap/m/Button', 'sap/m/Text', 'sap/m/MessageBox', 'sap/fe/actions/messageHandling'],
	function(UI5ControlFactory, Button, Text, MessageBox, messageHandling) {
		'use strict';
			...
			function showMessageBox(draftAdminData) {
				return new Promise(function(resolve, reject) {
					var sInfo = draftAdminData.CreatedByUserDescription || draftAdminData.CreatedByUser,
					    oDialog = UI5ControlFactory.getDialogControl({

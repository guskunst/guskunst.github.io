...
sap.ui.define(["sap/fe/actions/operations"],
	function(operations) {
		'use strict';
		 ...
		 *
		 * @function
		 * @name sap.fe.actions.sticky#editDocumentInStickySession
		 * @memberof sap.fe.actions.sticky
		 * @static
		 ...
		 *
		 * @function
		 * @name sap.fe.actions.sticky#activateDocument
		 * @memberof sap.fe.actions.sticky
		 * @static
		 ...
		 *
		 * @function
		 * @name sap.fe.actions.sticky#discardDocument
		 * @memberof sap.fe.actions.sticky
		 * @static

...
sap.ui.define([
    ...
    "sap/base/Log"
], function (URI, chipinstance, catalog, chipdefinition, ManifestPropertyHelper, Log) {
    "use strict";
    ...
    var LaunchPageAdapter = function (oUnused, sParameter, oAdapterConfiguration) {
        ...
        this.resetGroup = function (oGroup) {
            ...
            if (oCurrentPageSet.isPageRemovable(oGroup)) {
                ...
                oCurrentPageSet.resetPage(oGroup, function () {
                    that._loadApplaunchersAndDelayLoadingOfOtherChips([oGroup],
         ...
         *     the CHIP instance
         * @returns {string}
         *     the type. either <code>"tile"</code> or <code>"link"</code> or <code>"card"</code>.
         * @since 1.32.0
         */
         ...
         *
         * @param {sap.ui2.srvc.ChipInstance} card
         *     the CHIP instance
         * @returns {object}
         *     The card's manifest
         * @private

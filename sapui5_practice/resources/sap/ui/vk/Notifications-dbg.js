...
sap.ui.define([
	"jquery.sap.global", "./library", "sap/ui/core/Control", "./Messages", "sap/m/ToggleButton", "./NotificationsRenderer"
], function(jQuery, library, Control, Messages, ToggleButton, NotificationsRenderer) {
	"use strict";

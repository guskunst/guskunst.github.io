...
sap.ui.define([
	...
	SceneOrientationToolGizmo.prototype.init = function() {
		...
		this._scene.add(createGizmoAxis(new THREE.Vector3(1, 0, 0), library.AxisColours.x));
		this._scene.add(createGizmoAxis(new THREE.Vector3(0, 1, 0), library.AxisColours.y));
		this._scene.add(createGizmoAxis(new THREE.Vector3(0, 0, 1), library.AxisColours.z));

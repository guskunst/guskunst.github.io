...
sap.ui.define([
	...
	ScaleToolGizmo.prototype.init = function() {
		...
		// create 3 boxes
		this._gizmo.add(createGizmoBox(new THREE.Vector3(1, 0, 0), library.AxisColours.x, this._touchAreas));
		this._gizmo.add(createGizmoBox(new THREE.Vector3(0, 1, 0), library.AxisColours.y, this._touchAreas));
		this._gizmo.add(createGizmoBox(new THREE.Vector3(0, 0, 1), library.AxisColours.z, this._touchAreas));
	...
	ScaleToolGizmo.prototype._updateGizmoPartVisibility = function() {
		var screenSystem = this._coordinateSystem === library.CoordinateSystem.Screen;
	...
	ScaleToolGizmo.prototype._getAnchorPoint = function() {

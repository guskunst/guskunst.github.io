...
sap.ui.define([
	"jquery.sap.global", "./library", "sap/ui/core/Control", "sap/ui/core/ResizeHandler", "./Loco", "./ViewportHandler", "./Messages", "./ContentConnector", "./NativeViewportRenderer"
], function(jQuery, library, Control, ResizeHandler, Loco, ViewportHandler, Messages, ContentConnector, NativeViewportRenderer) {
	"use strict";

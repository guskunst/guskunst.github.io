...
sap.ui.define([
	...
	"sap/m/Title", "sap/m/SearchField", "sap/m/Toolbar", "sap/m/ToolbarLayoutData", "sap/m/ToolbarSpacer", "sap/m/Text", "sap/ui/core/Icon", "./ContentConnector", "./ViewStateManager", "./SceneTreeRenderer"
], function(jQuery, library, Control, TreeTable, Column, JSONModel, ResizeHandler,
		Title, SearchField, Toolbar, ToolbarLayoutData, ToolbarSpacer, Text, Icon, ContentConnector, ViewStateManager, SceneTreeRenderer) {
	"use strict";

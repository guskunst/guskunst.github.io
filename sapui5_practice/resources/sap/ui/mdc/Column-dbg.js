...
sap.ui.define([
	...
	Column.prototype.setCreationTemplate = function(oTemplate) {
		this._oCreationTemplate = oTemplate;
		return this;
	};
	...
	Column.prototype.getCreationTemplate = function(bClone) {
		...
		if (!this._oCreationTemplateClone && this._oCreationTemplate) {
			this._oCreationTemplateClone = this._oCreationTemplate.clone();
		}
		return bClone ? this._oCreationTemplateClone : this._oCreationTemplate;
	};
	...
	Column.prototype.exit = function() {
		...
		if (this._oCreationTemplate) {
			this._oCreationTemplate.destroy();
			this._oCreationTemplate = null;
		}

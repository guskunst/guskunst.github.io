...
sap.ui.define([], function() {
	...
	var TableHelper = {
		...
		getRestrictionsPath:function(oCollection){
			if (oCollection["@Org.OData.Capabilities.V1.DeleteRestrictions"] && oCollection["@Org.OData.Capabilities.V1.DeleteRestrictions"].Deletable.$Path){
				return ', $select : \'' + oCollection["@Org.OData.Capabilities.V1.DeleteRestrictions"].Deletable.$Path + '\'';
			} else {
				return '';
			}
		}

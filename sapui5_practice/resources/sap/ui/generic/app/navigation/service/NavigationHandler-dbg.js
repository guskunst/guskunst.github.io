...
// }
		 ...
		 * @param {object} oData with potential sensitive information (as oData the oSelectionVariant.toJSONObject() external representation is
		 *        expected, which has a ParameterContextUrl property)

...
sap.ui.define(function () {
    ...
    override._adaptCurrentGroup = function (aBindingContexts, aItems) {
        // When the item from the new group or the current item is a card, updating the item by only
        // changing the binding context of the current item does not work. To solve this issue, the current
        // item and its following items are destroyed, and new items are created and added later.
        var i,
            bIsCurrentItemACard,
            bIsNewItemACard;
